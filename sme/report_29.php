...
<head>
    ...
    <script src="js/report_29.js?<?php echo rand(); ?>"></script>
    <style>
            ...
            <div class="groupdata">
                <form id="frm-search" method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>">
                    ...
                    if ($_POST['s_round_year_bud'] != "") {
                        ...
                        $html .= '<tr >';
                        $html .= '<th class="" colspan="5" style="vertical-align:middle;background-color:#7bacf5;" ><div align="left" style="width:100%;"  ><strong>กระทรวง</strong></div></th>';
                        ...
                        $html .= '<tr >';
                        $html .= '<th class="" colspan="5" style="vertical-align:middle;background-color:#afcefb;" ><div align="left" style="width:100%;"  ><strong>หน่วยงาน</strong></div></th>';
