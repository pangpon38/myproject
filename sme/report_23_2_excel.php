...
header("Content-Disposition: attachment;filename=report_23_2_xls.xls");
...
<body>
    ...
    if ($_POST['s_round_year_bud'] != "") {
        ...
        $html .= '<div class="row">
								<div align="center" >
									<strong>พื้นที่แนวทาง (โครงการ) ปี ' . $text_year . '</strong>
        ...
        $html .= '<tr >';
        $html .= '<th class="" colspan="5" style="vertical-align:middle;background-color:#FFFFFF;" ><div align="center" style="width:100%;"  ><strong>ตัวชี้วัดที่ 1.1</strong></div></th>';
        $html .= '<th class="" style="vertical-align:middle;background-color:#FFFFFF;" ><div align="center" style="width:100%;"  ><strong></strong></div></th>';
        for ($i = 0; $i < $total_row; $i++) {
            $html .= '<th class="" style="vertical-align:middle;background-color:#FFFFFF;" ><div align="center" style="width:100%;"  ><strong></strong></div></th>';
        }
