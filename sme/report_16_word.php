...
header('Content-Disposition: attachment; filename="รายงานผลหน่วยงาน.doc"'); #ชื่อไฟล์
$path = "../../";
...
<body>
    ...
    if ($_POST['s_round_year_bud'] != "") {
        ...
        $html .= '<div class="row">
								<div align="center" >
									<strong>2. รายงานผลหน่วยงาน ปี ' . $text_year . '</strong>
        ...
        $html .= '<td class="" rowspan="2" style="vertical-align:middle;background-color:#ffffff;" ><div align="center" style="width:4cm;"  ><strong> งบประมาณ<br>(1) </strong></div></td>';
        $html .= '<td class="" colspan="2" style="vertical-align:middle;background-color:#ffffff;" ><div align="center" style="width:100%;"  ><strong> ตัวชี้วัด </strong></div></td>';
        $html .= '<td class="" colspan="6" style="vertical-align:middle;background-color:#ffffff;" ><div align="center" style="width:100%;"  ><strong> ผลการดำเนินงาน </strong></div></td>';
        $html .= '<td class="" colspan="6" style="vertical-align:middle;background-color:#ffffff;" ><div align="center" style="width:100%;"  ><strong> ผลการเบิกจ่ายงบประมาณ (บาท)<br>(2) </strong></div></td>';
        $html .= '<td class="" colspan="2" style="vertical-align:middle;background-color:#ffffff;" ><div align="center" style="width:100%;"  ><strong> ผูกพัน(3) </strong></div></td>';
        $html .= '<td class="" colspan="2" style="vertical-align:middle;background-color:#ffffff;" ><div align="center" style="width:100%;"  ><strong> เบิกจ่ายรวมผูกพัน<br>(4)=(2)+(3) </strong></div></td>';
        $html .= '<td class="" colspan="2" style="vertical-align:middle;background-color:#ffffff;" ><div align="center" style="width:100%;"  ><strong> คงเหลือ<br>(5)=(1)-(4) </strong></div></td>';
        $html .= '</tr>';
        ...
        $html .= '<td class="" style="vertical-align:middle;background-color:#ffffff;" ><div align="center" style="width:3cm;"  ><strong> เป้าหมาย </strong></div></td>';
        ...
        $html .= '<td class="" style="vertical-align:middle;background-color:#ffffff;" ><div align="center" style="width:3cm;"  ><strong> รวม </strong></div></td>';
        $html .= '<td class="" style="vertical-align:middle;background-color:#ffffff;" ><div align="center" style="width:3cm;"  ><strong> % </strong></div></td>';
        $html .= '<td class="" style="vertical-align:middle;background-color:#ffffff;" ><div align="center" style="width:3cm;"  ><strong> บาท </strong></div></td>';
        $html .= '<td class="" style="vertical-align:middle;background-color:#ffffff;" ><div align="center" style="width:3cm;"  ><strong> % </strong></div></td>';
        $html .= '<td class="" style="vertical-align:middle;background-color:#ffffff;" ><div align="center" style="width:3cm;"  ><strong> บาท </strong></div></td>';
        $html .= '<td class="" style="vertical-align:middle;background-color:#ffffff;" ><div align="center" style="width:3cm;"  ><strong> % </strong></div></td>';
        $html .= '<td class="" style="vertical-align:middle;background-color:#ffffff;" ><div align="center" style="width:3cm;"  ><strong> บาท </strong></div></td>';
