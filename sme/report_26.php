...
<head>
    ...
    <script src="js/report_26.js?<?php echo rand(); ?>"></script>
    <style>
            ...
            <div class="groupdata">
                <form id="frm-search" method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>">
                    ...
                    if ($_POST['s_round_year_bud'] != "") {
                        ...
                        $html .= '<tr >';
                        $html .= '<th class="" colspan="9" style="vertical-align:middle;background-color:#7bacf5;" ><div align="left" style="width:100%;"  ><strong>กระทรวง</strong></div></th>';
                        for ($i = 0; $i < $total_row; $i++) {
                        ...
                        $html .= '<tr >';
                        $html .= '<th class="" colspan="9" style="vertical-align:middle;background-color:#afcefb;" ><div align="left" style="width:100%;"  ><strong>หน่วยงาน</strong></div></th>';
                        for ($i = 0; $i < $total_row; $i++) {
