...
$sql_head="SELECT PRJP_ID,PRJP_CODE,PRJP_NAME,PRJP_CON_ID,MONEY_BDG,BDG_TYPE_ID FROM prjp_project WHERE PRJP_ID = '".$PRJP_ID."'";
							...
							<div class="panel panel-default">
								...
								<div class="panel-body epm-gradient" >
									...
									<div class=" col-xs-12 col-sm-12" style="display:none;" id="data_old">
										<table width="100%">
											<tr>
												<td align="center"><font size="+1"><?php echo $rec_head_old['PRJP_CODE']." ".text($rec_head_old['PRJP_NAME']) ?></font></td>
											</tr>
										</table>
										<br />
											...
											<table width="22%" class="table table-bordered table-striped table-hover table-condensed">
											  <thead>
												<tr class="bgHead">
												  ...
												  <th width="25%"><div align="center"><strong>กิจกรรม</strong></div></th>
												  <th width="5%"><div align="center"><strong>เป้าหมาย</strong></div></th>
												  <th width="5%"><div align="center"><strong>หน่วยนับ</strong></div></th>
												  <th width="10%"><div align="center"><strong>วงเงินงบประมาณกิจกรรม</strong></div></th>
												  <th width="5%"><div align="center"><strong>น้ำหนัก(%)</strong></div></th>
												</tr>
											  </thead>
											  <tbody>
												<?php
								...
								<div class="row">  
									<div class="col-xs-12 col-sm-12">
										<?php if($_SESSION['sys_status_add']=='1'){ ?>
											<!--<a class="btn btn-primary" href="javascript:void(0);" onClick="mouData('<?php echo $PRJP_ID; ?>');"><?php echo $img_save; ?> เพิ่มสัญญา</a>-->
									...
									<div class="col-xs-12 col-sm-12">
									  <div class="">
										<table width="22%" class="table table-bordered table-striped table-hover table-condensed">
										  <thead>
											<tr class="bgHead">
											  <th width="" nowrap><div align="center"><strong>ลำดับ</strong></div></th>
											  <th width="100%" nowrap><div align="center"><strong>กิจกรรม</strong></div></th>
											  <th width="" nowrap><div align="center"><strong>ประเภทค่าใช้จ่าย</strong></div></th>
											  <th width="" nowrap><div align="center"><strong>เป้าหมาย</strong></div></th>
											  <th width="" nowrap><div align="center"><strong>หน่วยนับ</strong></div></th>
											  <th width="" nowrap><div align="center"><strong>วงเงิน<br />งบประมาณ<br />กิจกรรม</strong></div></th>
											  <th width="" nowrap><div align="center"><strong>น้ำหนัก(%)</strong></div></th>
											</tr>
											</thead>
											<tbody>
											<?php
