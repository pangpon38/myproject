            ...
            <input type="hidden" id="hide_show" name="hide_show"  value="<?php echo $_POST['hide_show'];?>">
        		<a href="#" class="hide_search"  style="color:#000;" ><?php echo $img_down;?></a>
                    ...
                    if ($_POST['s_round_year_bud'] != "") {
                        ...
                        $html .= '<div class="row">
								<div align="center" >
									<strong>1. รายงานผลการดำเนินงาน และผลการเบิกจ่ายงบประมาณรายไตรมาส(จำแนกตามแนวทางการดำเนินงาน) ภายใต้แผนงานยุทธศาสตร์วิสาหกิจขนาดกลางและขนาดย่อม ปี '. $text_year .'</strong>
