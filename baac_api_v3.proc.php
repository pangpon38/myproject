...
define('secret_key', 'efgewr32234wsdvvbgwfwe');
...
switch ($_GET['proc']) {
    ...
    case 'getMember':
        ...
        $member = [
            ...
            'qrcode' => 'https://api.smartchapa.com/api/mobileapp/baac_qrcode.php?gencode=file&mno=' . hash('md5', $row['member_no'] . secret_key_qrcode) . '&bcode=' . hash('md5', $BAAC_CODE . secret_key_qrcode),
        ];
