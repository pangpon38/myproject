...
$sql_select_group = "SELECT a.GROUP_ID as group_name FROM USR_GROUP_SETTING a LEFT JOIN USR_GROUP b ON b.GROUP_ID = a.USR_ID WHERE a.USR_ID = '" . $_SESSION['WF_USER_ID'] . "'";
$query_group = db::query($sql_select_group);
$result_group = db::fetch_array($query_group);
$update_wf["DEP_ID"] = $_SESSION['DEP_ID'];
$update_wf['DIV_ID'] = $result_group['group_name'];
?>