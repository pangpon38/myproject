                    ...
                    <div class="row">
                        <div class="col-xs-12 col-sm-1">
                            <?php if ($_SESSION['sys_status_add'] == '1') { ?>
                                <a class="btn btn-success" data-toggle="modal" onclick="addData();"> <i class="fa fa-plus-circle" aria-hidden="true"></i> เพิ่มข้อมูล</a>
                            <?php } ?>
                        </div>
                    </div>
                    <div class="col-xs-12 col-sm-12">
                                ...
                                <tbody class="body">
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td nowrap>
                                                <a class="btn btn-warning" data-toggle="modal" onclick="editData(<?php echo $rec_main['PRJP_RISK_ID']; ?>,<?php echo $PRJP_ID; ?>,'edit_lesson');"><i class="fa fa-edit" aria-hidden="true"></i> แก้ไข</a>
                                                <a class="btn btn-danger" onclick="delData(<?php echo $rec_main['PRJP_RISK_ID']; ?>,<?php echo $PRJP_ID; ?>);"><i class="fa fa-trash" aria-hidden="true"></i> ลบ</a>
                                            </td>
                                        </tr>
                                    <?php
                                        $i++;
