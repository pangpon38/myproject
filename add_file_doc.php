        ...
        <div class="row" id="animationSandbox">
    		...
    		<div class="row">
    			<div class="col-md-12">
                    ...
                    <input type="hidden" name="m_group_code" id="m_group_code" value="<?php echo $rec_chk_lock["MEDIA_GROUP_CODE"]; ?>">
                        <div class="form-group row">
                            <div id="DOC_FILE_BSF_AREA" class="col-md-2 offset-md-1 ">
                            <label for="DOC_FILE" class="form-control-label wf-right">เอกสารแนบ<span class="text-danger">*</span></label></div>
