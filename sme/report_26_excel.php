...
header("Content-Disposition: attachment;filename=report_26_xls.xls");
$path = "../../";
...
<body>
    ...
    if ($_POST['s_round_year_bud'] != "") {
        ...
        $html .= '<div class="row">
								<div align="center" >
									<strong>มูลค่าเศรษฐกิจหน่วยงาน ปี ' . $text_year . '</strong>
        ...
        $html .= '<tr >';
        $html .= '<th class="" colspan="9" style="vertical-align:middle;background-color:#ffffff;" ><div align="left" style="width:100%;"  ><strong>กระทรวง</strong></div></th>';
        for ($i = 0; $i < $total_row; $i++) {
            $html .= '<th class="" style="vertical-align:middle;background-color:#ffffff;" ><div align="center" style="width:100%;"  ><strong></strong></div></th>';
        }
        $html .= '</tr>';
        ...
        $html .= '<tr >';
        $html .= '<th class="" colspan="9" style="vertical-align:middle;background-color:#ffffff;" ><div align="left" style="width:100%;"  ><strong>หน่วยงาน</strong></div></th>';
        for ($i = 0; $i < $total_row; $i++) {
            $html .= '<th class="" style="vertical-align:middle;background-color:#ffffff;" ><div align="center" style="width:100%;"  ><strong></strong></div></th>';
        }
        $html .= '</tr>';
