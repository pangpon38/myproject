                                                ...
                                                <tbody>
                                                    ...
                                                    ?>
                                                            <tr bgcolor="#FFFFFF" class="">
                                                                ...
                                                                <td align="left">
                                                                    <textarea rows="3" style="width:100%" class="prjp-name-show" <?php echo $disables_txt; ?>><?php echo text($rec['risk_name']); ?></textarea>
                                                                </td>
                                                                <td align="left">
                                                                    <textarea rows="3" style="width:100%" class="prjp-name-show" <?php echo $disables_txt; ?>><?php echo text($rec['risk_grade']); ?></textarea>
                                                                </td>
                                                                <td align="left">
                                                                    <textarea rows="3" style="width:100%" class="prjp-name-show" <?php echo $disables_txt; ?>><?php echo text($rec['risk_manage']); ?></textarea>
                                                                </td>
                                                                <td align="left">
                                                                    <textarea rows="3" style="width:100%" class="prjp-name-show" <?php echo $disables_txt; ?>><?php echo text($rec['risk_response_by']); ?></textarea>
                                                                </td>
                                                                <td align="left">
                                                                    <textarea rows="3" style="width:100%" class="prjp-name-show" <?php echo $disables_txt; ?>><?php echo text($rec['risk_cost']); ?></textarea>
                                                                </td>
                                                            </tr>
                                                    <?php
                                                            $l++;
