...
$select_data = "SELECT * FROM prjp_eco WHERE PRJP_ID = '{$PRJP_ID}' ";
    ...
    <div class="container-full">
        ...
        <div class="col-xs-12 col-sm-12">
            <ol class="breadcrumb">
                ...
                <li><a
                        href="disp_send_project.php?<?php echo url2code("menu_id=" . $menu_id . "&menu_sub_id=" . $menu_sub_id); ?>"><?php echo Showmenu($menu_sub_id); ?></a>
                </li>
        ...
        <div class="col-xs-12 col-sm-12">
            <div class="groupdata">
                <form id="frm-search" method="post" action="economic_value_process.php"
                    ...
                    <input type="hidden" id="year_round" name="year_round"
                        value="<?php echo $_SESSION['year_round']; ?>">
                    <input type="hidden" id="code_user" name="code_user"
                        value="<?php echo $_SESSION['sys_dept_id']; ?>">
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <input type="file" name="imp_economic" id="imp_economic"
                                                placeholder="แบบประเมินมูลค่า ศก. สำหรับผู้รับผิดชอบโครงการ"
                                                class="form-control"
                                    ...
                                    <div class="row">
                                        <div class="col-md-12" style="text-align:center;">
                                            <input type="hidden" id="PRJP_ID" name="PRJP_ID"
                                                value="<?php echo $PRJP_ID; ?>">
                                            <label><input type="checkbox" id="chk_apt" onchange="chk_accept();">
                                                ยืนยันว่าการบันทึกข้อมูลครั้งนี้เป็นไปตาม </label> <a class="btn-link"
                                                href="<?php echo $path; ?>fileupload_admin/หนังสือให้ความยินยอมในการเปิดเผยข้อมูลส่วนบุคคล.pdf"
                                                target="_blank"> พ.ร.บ.คุ้มครองข้อมูลส่วนบุคคล</a>
                                            <br>
                                            <button type="button" class="btn btn-success " onClick="imp_file();"
                                                id="btn_accept" disabled><i class="fa fa-check" aria-hidden="true"></i>
                                                บันทึก</button>
                                            <button type="button" class="btn btn-danger" data-dismiss="modal"><i
                                                    class="fa fa-close" aria-hidden="true"></i> ยกเลิก</button>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-12">
                            <div class="panel panel-default">
                                ...
                                <div class="panel-body epm-gradient">
                                    ...
                                    <div class="row">
                                        <div class="col-xs-12 col-sm-12">
                                            <?php echo $print_form; ?>&nbsp;<?php echo $import; ?></div>
                                    </div>
                                    <div class="row">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-xs-12 col-sm-2 ">
                                            <input type="text" id="micro" name="micro" class="form-control text-right"
                                                onblur="NumberFormat(this,0);"
                                                value="<?php echo number_format($rec_data["micro"]); ?>">
                                        </div>
                                        <div class="col-xs-12 col-sm-1 "> ราย </div>
                                        <div class="col-xs-12 col-sm-1 "> Small </div>
                                        <div class="col-xs-12 col-sm-2 ">
                                            <input type="text" id="small" name="small" class="form-control text-right"
                                                onblur="NumberFormat(this,0);"
                                                value="<?php echo number_format($rec_data["small"]); ?>">
                                        </div>
                                        <div class="col-xs-12 col-sm-1 "> ราย </div>
                                        <div class="col-xs-12 col-sm-1 "> Medium </div>
                                        <div class="col-xs-12 col-sm-2 ">
                                            <input type="text" id="medium" name="medium" class="form-control text-right"
                                                onblur="NumberFormat(this,0);"
                                                value="<?php echo number_format($rec_data["medium"]); ?>">
                                        </div>
                                        <div class="col-xs-12 col-sm-1 "> ราย </div>
                                    </div>
                                    <div class="row">
                                        ...
                                        <div class="col-xs-12 col-sm-2 ">
                                            <input type="text" id="smce" name="smce" class="form-control text-right"
                                                onblur="NumberFormat(this,0);"
                                                value="<?php echo number_format($rec_data["smce"]); ?>">
                                        </div>
                                        <div class="col-xs-12 col-sm-1 "> ราย </div>
                                        <div class="col-xs-12 col-sm-1 "> กลุ่มอาชีพ </div>
                                        <div class="col-xs-12 col-sm-2 ">
                                            <input type="text" id="group_prof" name="group_prof" class="form-control text-right"
                                                onblur="NumberFormat(this,0);"
                                                value="<?php echo number_format($rec_data["group_prof"]); ?>">
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-xs-12 col-sm-3 "> ระบุจำนวนผู้ที่ตอบแบบรายงาน </div>
                                        <div class="col-xs-12 col-sm-2 ">
                                            <input type="text" id="count_person" name="count_person"
                                                class="form-control text-right" onblur="NumberFormat(this,0);"
                                                value="<?php echo number_format($rec_data["count_person"]); ?>">
                                        </div>
                                        <div class="col-xs-12 col-sm-1 "> ราย </div>
                                    </div>
                                    <div class="row">
                                        ...
                                        <div class="col-xs-12 col-sm-3 ">
                                            <input type="text" id="Fname" name="Fname" class="form-control"
                                                value="<?php echo text($rec_data["Fname"]); ?>">
                                        </div>
                                        <div class="col-xs-12 col-sm-2 ">
                                            นามสกุล
                                        </div>
                                        <div class="col-xs-12 col-sm-3 ">
                                            <input type="text" id="Lname" name="Lname" class="form-control"
                                                value="<?php echo text($rec_data["Lname"]); ?>">
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-xs-12 col-sm-3 ">
                                        ...
                                        <div class="col-xs-12 col-sm-3 ">
                                            <input type="text" id="position" name="position" class="form-control"
                                                value="<?php echo text($rec_data["position"]); ?>">
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-xs-12 col-sm-3 ">
                                        ...
                                        <div class="col-xs-12 col-sm-3 ">
                                            <input type="text" id="ORG_NAME" name="ORG_NAME" class="form-control"
                                                value="<?php echo text($rec_data["ORG_NAME"]); ?>">
                                        </div>
                                        <div class="col-xs-12 col-sm-2 ">
                                            กอง/สำนัก/ฝ่าย
                                        </div>
                                        <div class="col-xs-12 col-sm-3 ">
                                            <input type="text" id="ORG_NAME2" name="ORG_NAME2" class="form-control"
                                                value="<?php echo text($rec_data["ORG_NAME2"]); ?>">
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-xs-12 col-sm-2 ">
                                        ...
                                        <div class="col-xs-12 col-sm-3 ">
                                            ...
                                            <select id="associated" name="associated" class="selectbox form-control">
                                                <option value=""></option>
                                                <option value="1"
                                                    <?php echo $rec_data["associated"] == 1 ? "selected" : ""; ?>>
                                                    หัวหน้าโครงการ</option>
                                                <option value="2"
                                                    <?php echo $rec_data["associated"] == 2 ? "selected" : ""; ?>>
                                                    ผู้รับผิดชอบโครงการ(ผู้ดำเนินโครงการ)</option>
                                                <option value="3"
                                                    <?php echo $rec_data["associated"] == 3 ? "selected" : ""; ?>>
                                                    ผู้ประสานงานโครงการ</option>
                                            </select>
                                            <?php } else {?>
                                            <input type="text" id="associated_text" name="associated_text"
                                                class="form-control"
                                                value="<?php echo text($rec_data["associated_text"]); ?>" readonly>
                                            <?php }?>
                                        </div>
                                    </div>
                                    <div class="row">
                                        ...
                                        <div class="col-xs-12 col-sm-2 ">
                                            <input type="text" id="telephone" name="telephone" class="form-control"
                                                value="<?php echo $rec_data["telephone"]; ?>">
                                        </div>
                                        <div class="col-xs-12 col-sm-2 ">
                                            โทรศัพท์มือถือ
                                        </div>
                                        <div class="col-xs-12 col-sm-2 ">
                                            <input type="text" id="mobile" name="mobile" class="form-control"
                                                value="<?php echo $rec_data["mobile"]; ?>">
                                        </div>
                                        <div class="col-xs-12 col-sm-1 ">
                                            E-Mail
                                        </div>
                                                    ...
                                                    <tbody>
														<?php for($no=1; $no<=9; $no++){ ?>
															<tr>
																...
																<td colspan="1"><input style="" type="text"
																		id="<?php echo $arr_eco_field[$no]; ?>_inc"
																		name="<?php echo $arr_eco_field[$no]; ?>_inc"
																		class="form-control text-right"
																		onblur="NumberFormat(this,2);sum_eco_1(1);sum_eco_9(1);eco_result('<?php echo $arr_eco_field[$no]; ?>');sum_eco_value();"
																		value="<?php echo number_format($rec_data[$arr_eco_field[$no] . '_inc'], 2) ?>">
																</td>
																<td colspan="1"><input style="" type="text"
																		id="<?php echo $arr_eco_field[$no]; ?>_same"
																		name="<?php echo $arr_eco_field[$no]; ?>_same"
																		class="form-control text-right"
																		onblur="NumberFormat(this,2);sum_eco_1(2);sum_eco_9(2);eco_result('<?php echo $arr_eco_field[$no]; ?>');sum_eco_value();"
																		value="<?php echo number_format($rec_data[$arr_eco_field[$no] . '_same'], 2) ?>">
																</td>
																<td colspan="1">
																	<textarea style="width:100%" row="3" id="<?php echo $arr_eco_field[$no]; ?>_cal_end" name="<?php echo $arr_eco_field[$no]; ?>_cal_end" class="form-control" ><?php echo $rec_data[$arr_eco_field[$no] . '_cal_end'] ?></textarea>
																</td>
																<td colspan="1">
																	<textarea style="width:100%" row="3" id="<?php echo $arr_eco_field[$no]; ?>_cal_year" name="<?php echo $arr_eco_field[$no]; ?>_cal_year" class="form-control" ><?php echo $rec_data[$arr_eco_field[$no] . '_cal_year'] ?></textarea>
																</td>
																<td colspan="1">
																	<textarea style="width:100%" row="3" id="<?php echo $arr_eco_field[$no]; ?>_cal_data" name="<?php echo $arr_eco_field[$no]; ?>_cal_data" class="form-control" ><?php echo $rec_data[$arr_eco_field[$no] . '_cal_data'] ?></textarea>
																</td>
															</tr>
                                                        <?php } ?>
                                                        <tr><?php $no = "10";?>
													...
													<tbody>
														...
														foreach ($arr_eco_field_det2 as $no => $text) {?>
															<tr>
																<?php $dot = explode(".", $no);?>
																<td colspan="1" nowrap>
																	<?php if($text != ''){echo empty($dot[1]) ? $no . "." : "";} ?></td>
																<td colspan="3">
																	<span><?php if($text != ''){echo empty($dot[1]) ? $text : $no . ". " . $text;} ?></span>
																	<?php if (trim($arr_eco_i[$no]) != '') {echo '<a class="data-info" data-placement="right" data-title="" data-content="' . $arr_eco_i[$no] . '" > </a>';}?>
																</td>
																<?php 
																if (trim($arr_col_D[$no]) != '') { ?>
																	...
																	<td width="15%"><input style="" type="text"
																			id="<?php echo $arr_eco_field[$no]; ?>_same"
																			name="<?php echo $arr_eco_field[$no]; ?>_same"
																			class="form-control text-right"
																			onblur="NumberFormat(this,2);"
																	...
																	if ($no == '16.1' || $no == '16.2') {?>
																		<td colspan="6">
																			<textarea
																				id="<?php echo $arr_eco_field[$no]; ?>_comment"
																				name="<?php echo $arr_eco_field[$no]; ?>_comment"
																				class="form-control"><?php echo text($rec_data[$arr_eco_field[$no] . '_comment']); ?></textarea>
																		</td>
																		<?php 
																	} else {?>
																		<td colspan="3"></td>
																...
																if (trim($arr_col_G[$no]) != '') { ?>
																	...
																	<td width="15%"><input style="" type="text"
																			id="<?php echo $arr_eco_field[$no]; ?>_value"
																			name="<?php echo $arr_eco_field[$no]; ?>_value"
																			class="form-control text-right"
																			onblur="NumberFormat(this,2);"
																			value="<?php echo number_format($rec_data[$arr_eco_field[$no] . '_value'], 2) ?>">
																	</td>
																	<td align="center">
                    ...
                    <div class="row">
                        <div class="col-md-12" style="white-space:nowrap;">
                            <center>
                                <label><input type="checkbox" id="chk_apt2" onchange="chk_accept2();">
                                    ยืนยันว่าการบันทึกข้อมูลครั้งนี้เป็นไปตาม </label> <a class="btn-link"
                                    href="<?php echo $path; ?>fileupload_admin/หนังสือให้ความยินยอมในการเปิดเผยข้อมูลส่วนบุคคล.pdf"
                                    target="_blank"> พ.ร.บ.คุ้มครองข้อมูลส่วนบุคคล</a>
                                <br>
                                <button type="button" class="btn btn-success " onClick="chkinput2();" id="btn_accept2"
                                    disabled><i class="fa fa-check" aria-hidden="true"></i> บันทึก</button>
                            </center>
                        </div>
                    </div>
                    <?php }?>
