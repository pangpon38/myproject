...
<script src="js/bdg_payment_report_js.js?<?php echo rand(); ?>"></script>
<style>
	.table-freeze > thead > tr:nth-child(1) > th, .table-freeze > thead > tr:nth-child(1) > td{
		position: sticky;
		top:0;
		z-index:1;
	}
	.table-freeze > thead > tr:nth-child(2) > th, .table-freeze > thead > tr:nth-child(2) > td{
		position: sticky;
		top:39px;
		z-index:1;
	}
	.table-freeze > thead > tr:nth-child(1) > .freez-1, .table-freeze > thead > tr:nth-child(1) > .freez-2{
		z-index:2 !important;
	}
	.freez-1{
		position: sticky;
     ...
     <?php /*?> <div class="row">
          ...
          if($_POST['s_round_year_bud']!=""){
			  ...
			  $html = '';
				  $html .= '<div class="row">
								<div align="center" >
									<strong>รายงานผลความคืบหน้าการดำเนินงานตามตัวชี้วัดผลผลิต/ผลลัพธ์ ของงาน/โครงการ งบประมาณปี '.$text_year.' ตาม พ.ร.บ. งบประมาณรายจ่ายประจำปี ณ '.$arr_month_short[$MONTH_NOW].' '.$YEAR_NOW_SH.' </strong>
								</div>
							</div>
							<div class="row">
								<div align="center" >
			 ...
			 //class="table table-bordered table-striped table-hover table-condensed" width="100%"
					$html .= '<table  border="1" width="100%" class=" table-hover table-condensed table-freeze" style="border-collapse: collapse;background-color:#FFFFFF;">';
						$html .= '<thead>';
							$html .= '<tr >';
								$html .= '<th class="" rowspan="2" colspan="1" style="vertical-align:middle;background-color:#BDBDBD;" ><div align="center" style="width:3cm;"  ><strong> ปีงบประมาณ </strong></div></th>';
								$html .= '<th class="" rowspan="1" colspan="2" style="vertical-align:middle;background-color:#BDBDBD;" ><div align="center" style="width:10cm;"  ><strong> แผน 4 </strong></div></th>';
								$html .= '<th class="" rowspan="1" colspan="2" style="vertical-align:middle;background-color:#BDBDBD;" ><div align="center" style="width:10cm;"  ><strong> แนวทาง </strong></div></th>';
								$html .= '<th class="" rowspan="1" colspan="2" style="vertical-align:middle;background-color:#BDBDBD;" ><div align="center" style="width:10cm;"  ><strong> ยุทธฯ สสว. </strong></div></th>';
								$html .= '<th rowspan ="2" colspan="1" style="vertical-align:middle;background-color:#BDBDBD;"><div align="center"><strong>กลุ่มการส่งเสริม SME</strong></div></th>';
								$html .= '<th rowspan ="2" colspan="1" style="vertical-align:middle;background-color:#BDBDBD;"><div align="center"><strong>ขนาดธุรกิจ</strong></div></th>';
								$html .= '<th rowspan ="2" colspan="1" style="vertical-align:middle;background-color:#BDBDBD;"><div align="center"><strong>รหัสโครงการ</strong></div></th>';
								$html .= '<th rowspan ="2" colspan="1" style="vertical-align:middle;background-color:#BDBDBD;"><div align="center" style="width:5cm;"><strong>โครงการ</strong></div></th>';
								$html .= '<th rowspan ="2" colspan="1" style="vertical-align:middle;background-color:#BDBDBD;"><div align="center"><strong>ฝ่าย</strong></div></th>';
								$html .= '<th rowspan ="2" colspan="1" style="vertical-align:middle;background-color:#BDBDBD;"><div align="center" style="width:3cm;"><strong>วันสิ้นสุดโครงการ</strong></div></th>';
								$html .= '<th rowspan ="2" colspan="1" style="vertical-align:middle;background-color:#BDBDBD;"><div align="center" style="width:4cm;"><strong>เงินงบประมาณ</strong></div></th>';
								$html .= '<th rowspan ="2" colspan="1" style="vertical-align:middle;background-color:#BDBDBD;"><div align="center" style="width:4cm;"><strong>เงินนอกงบประมาณ</strong></div></th>';
								$html .= '<th rowspan ="2" colspan="1" style="vertical-align:middle;background-color:#BDBDBD;"><div align="center" style="width:4cm;"><strong>รวมงบประมาณ</strong></div></th>';
								$html .= '<th rowspan ="2" colspan="2" style="vertical-align:middle;background-color:#BDBDBD;"><div align="center" style="width:4cm;"><strong>เบิกจ่ายจริง</strong></div></th>';
								$html .= '<th rowspan ="2" colspan="2" style="vertical-align:middle;background-color:#BDBDBD;"><div align="center" style="width:4cm;"><strong>ภาระผูกพัน</strong></div></th>';
								$html .= '<th rowspan ="2" colspan="2" style="vertical-align:middle;background-color:#BDBDBD;"><div align="center" style="width:4cm;"><strong>ยอดรวม</strong></div></th>';
								$html .= '<th rowspan ="2" colspan="2" style="vertical-align:middle;background-color:#BDBDBD;"><div align="center" style="width:4cm;"><strong>คงเหลือ</strong></div></th>';
								$html .= '<th rowspan ="2" colspan="1" style="vertical-align:middle;background-color:#BDBDBD;"><div align="center" style="width:6cm;"><strong>ตัวชี้วัดผลผลิต</strong></div></th>';
								$html .= '<th rowspan ="2" colspan="1" style="vertical-align:middle;background-color:#BDBDBD;"><div align="center" style="width:1.5cm;"><strong>เป้าหมาย</strong></div></th>';
								$html .= '<th rowspan ="2" colspan="1" style="vertical-align:middle;background-color:#BDBDBD;"><div align="center" style="width:1.5cm;"><strong>ผลที่ได้</strong></div></th>';
								$html .= '<th rowspan ="2" colspan="1" style="vertical-align:middle;background-color:#BDBDBD;"><div align="center" style="width:1.5cm;"><strong>หน่วยนับ</strong></div></th>';
								$html .= '<th rowspan ="2" colspan="1" style="vertical-align:middle;background-color:#BDBDBD;"><div align="center" style="width:6cm;"><strong>ตัวชี้วัดผลลัพธ์</strong></div></th>';
								$html .= '<th rowspan ="2" colspan="1" style="vertical-align:middle;background-color:#BDBDBD;"><div align="center" style="width:1.5cm;"><strong>เป้าหมาย</strong></div></th>';
								$html .= '<th rowspan ="2" colspan="1" style="vertical-align:middle;background-color:#BDBDBD;"><div align="center" style="width:1cm;"><strong>ผลที่ได้</strong></div></th>';
								$html .= '<th rowspan ="2" colspan="1" style="vertical-align:middle;background-color:#BDBDBD;"><div align="center" style="width:1.5cm;"><strong>หน่วยนับ</strong></div></th>';
							
								
							$html .= '</tr>';
							$html .= '<tr >';
										$html .= '<td rowspan="1" style="vertical-align:middle;background-color:#BDBDBD;" ><div align="center" style="width:2.5cm;"><strong> ยุทธฯ  </strong></div></td>';
										$html .= '<td rowspan="1" style="vertical-align:middle;background-color:#BDBDBD;" ><div align="center" style="width:2.5cm;"><strong> กลยุทธ์  </strong></div></td>';
										$html .= '<td rowspan="1" style="vertical-align:middle;background-color:#BDBDBD;" ><div align="center" style="width:2.5cm;"><strong> ยุทธฯ  </strong></div></td>';
										$html .= '<td rowspan="1" style="vertical-align:middle;background-color:#BDBDBD;"><div align="center" style="width:2.5cm;"><strong> กลยุทธ์  </strong></div></td>';
										$html .= '<td rowspan="1" style="vertical-align:middle;background-color:#BDBDBD;"><div align="center" style="width:2.5cm;"><strong> ยุทธฯ </strong></div></td>';
										$html .= '<td rowspan="1" style="vertical-align:middle;background-color:#BDBDBD;"><div align="center" style="width:2.5cm;"><strong> กลยุทธ์ </strong></div></td>';
						...
						$html .= '<tbody>';
									...
									if(count($arr_data_report3 > 0)){ //##  Start แนวทาง
										...
										foreach($arr_data_report3 as $k_1 => $v_1){ 
											...
											$html .= '<tr >';
                                            $html .= '<td ><div align="center"><strong> 2564 </strong></div></td>';
                                            $html .= '<td ><div align="center"><strong>  </strong></div></td>';
                                            $html .= '<td ><div align="center"><strong>  </strong></div></td>';
                                            $html .= '<td ><div align="center"><strong>  </strong></div></td>';
                                            $html .= '<td ><div align="center"><strong>  </strong></div></td>';
                                            $html .= '<td ><div align="center"><strong> 1 </strong></div></td>';
                                            $html .= '<td ><div align="center"><strong> 1.1 </strong></div></td>';
                                            $html .= '<td ><div align="center"><strong>  </strong></div></td>';
                                            $html .= '<td ><div align="center"><strong>  </strong></div></td>';
                                            $html .= '<td ><div align="center"><strong>64010010  </strong></div></td>';
                                            $html .= '<td ><div align="center"><strong>งานจัดทำแผนปฏิบัติการส่งเสริมวิสาหกิจขนาดกลางและขนาดย่อม </strong></div></td>';
                                            $html .= '<td ><div align="center"><strong>ฝนผ.</strong></div></td>';
                                            $html .= '<td ><div align="center"><strong>30 ก.ย. 64</strong></div></td>';
                                            $html .= '<td ><div align="center"><strong>1,408,000.00</strong></div></td>';
                                            $html .= '<td ><div align="center"><strong>1,500,000.00</strong></div></td>';
                                            $html .= '<td ><div align="center"><strong>2,908,000.00</strong></div></td>';
                                            $html .= '<td colspan="0.5"><div align="center"><strong>132,375.45</strong></div></td>';
                                            $html .= '<td colspan="0.5"><div align="center"><strong>4.55%</strong></div></td>';
                                            $html .= '<td colspan="0.5"><div align="center"><strong>2,500,000.00</strong></div></td>';
                                            $html .= '<td colspan="0.5"><div align="center"><strong>%</strong></div></td>';
                                            $html .= '<td colspan="0.5"><div align="center"><strong>2,632,375.45</strong></div></td>';
                                            $html .= '<td colspan="0.5"><div align="center"><strong>%</strong></div></td>';
                                            $html .= '<td colspan="0.5"><div align="center"><strong>275,624.55</strong></div></td>';
                                            $html .= '<td colspan="0.5"><div align="center"><strong>%</strong></div></td>';
                                            $html .= '<td colspan="0.5"><div align="center"><strong>แผนปฏิบัติการส่งเสริมวิสาหกิจขนาดกลางและขนาดย่อมประจำปี</strong></div></td>';
                                            $html .= '<td colspan="0.5"><div align="right"><strong>1</strong></div></td>';
                                            $html .= '<td colspan="0.5"><div align="right"><strong>1</strong></div></td>';
                                            $html .= '<td colspan="0.5"><div align="center"><strong>แผน</strong></div></td>';
                                            $html .= '<td colspan="0.5"><div align="center"><strong>หน่วยงานที่เกี่ยวข้องมีส่วนร่วมในการบูรณาการการดำเนินงานส่งเสริม SME</strong></div></td>';
                                            $html .= '<td colspan="0.5"><div align="right"><strong>35</strong></div></td>';
                                            $html .= '<td colspan="0.5"><div align="right"><strong>45</strong></div></td>';
                                            $html .= '<td colspan="0.5"><div align="center"><strong>หน่วยงาน</strong></div></td>';
                                            $html .= '</tr>'; 
