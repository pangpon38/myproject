                                    ...
                                    ?>
                                            <tr bgcolor="#FFFFFF">
                                                ...
                                                <td align="center" nowrap>
                                                    ...
                                                    <?php } ?>
                                                    <a class="btn btn-warning" data-toggle="modal" onclick="editData(<?php echo $rec['PRJP_ACT_CONTRACT_ID']; ?>,<?php echo $PRJP_ID; ?>);"><i class="fa fa-edit" aria-hidden="true"></i> แก้ไข</a>
