                            ...
                            <div class="panel panel-default">
                                ...
                                <div class="panel-body epm-gradient">
                                    <div class="row">
                                        ...
                                        <div class="col-xs-12 col-sm-8 col-md-4"> <input type="checkbox" <?php echo $disables_txt; ?> id="chk_show_sdate" name="chk_show_sdate" onClick="Chkshow();" value="Y" <?php echo ($rec_set_step_1['step_sdate'] != "") ? "checked" : ""; ?>> อนุมัติเปิดโครงการ </div>
                                        ...
                                        <span id="show_sdate_1">
                                            ...
                                            <div class="col-xs-12 col-sm-3 col-md-2">
                                                <div class="input-group">
                                                    <input type="text" <?php echo $disables_txt; ?> id="step_sdate_1" name="step_sdate_1" class="form-control <?php echo $_SESSION['sys_program_administrator'] == 1 ? '' : 'chk_empty'; ?>" placeholder="DD/MM/YYYY" maxlength="10" value="<?php echo conv_date($rec_set_step_1["step_sdate"]); ?>">
                                    ...
                                    <?php if ($_SESSION["sys_group_id"] == '5' || $_SESSION['sys_program_administrator'] == 1) { ?>
                                        <div class="row">
                                            ...
                                            <div class="col-xs-12 col-sm-8 col-md-4">
                                                <div class="input-group">
                                                    <select <?php echo $disables_txt; ?> id="ORG_TYPE_ID" name="ORG_TYPE_ID" class="selectbox form-control" placeholder="ประเภทหน่วยงาน" onChange="get_org(this);" style="width:100%">
                                            ...
                                            <div class="col-xs-12 col-sm-8 col-md-4">
                                                <!--<div class="input-group ">-->
                                                <select <?php echo $disables_txt; ?> id="ORG_ID" name="ORG_ID" class="selectbox form-control" placeholder="หน่วยงาน" onChange="get_con_prjid(this,'<?php echo $_SESSION['year_round']; ?>');" style="width:100% !important;">
                                                    <option value=""></option>
                                                    <?php
                                                    if (count($arr_org) > 0) {
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-xs-12 col-sm-8 col-md-5">
                                            <div class="input-group">
                                                <input <?php echo $disables_txt; ?> name="PRJP_STATUS" id="PRJP_STATUS1" type="radio" value="1" <?php echo ($rec['PRJP_STATUS'] == '1' || $rec['PRJP_STATUS'] == '' ? "checked" : ""); ?> onClick="show_prj('1');">&nbsp;โครงการใหม่
                                                <?php if ($proc == 'edit') { ?>
                                                    &nbsp;&nbsp;<input <?php echo $disables_txt; ?> name="PRJP_STATUS" id="PRJP_STATUS2" type="radio" value="2" <?php echo ($rec['PRJP_STATUS'] == '2' ? "checked" : ""); ?> onClick="show_prj('2');">&nbsp;โครงการขยายเวลา
                                                    &nbsp;&nbsp;<input <?php echo $disables_txt; ?> name="PRJP_STATUS" id="PRJP_STATUS3" type="radio" value="3" <?php echo ($rec['PRJP_STATUS'] == '3' ? "checked" : ""); ?> onClick="show_prj('3');">&nbsp;&nbsp;โครงการปรับแผนใหม่
                                                <?php } ?>
                                            </div>
                                        </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-xs-12 col-sm-8 col-md-10">
                                            <select <?php echo $disables_txt; ?> id="BDG_TYPE_ID" name="BDG_TYPE_ID" onchange="toggle_money(this.value);" class="selectbox form-control " placeholder="ประเภทโครงการ">
                                                <option value="" selected></option>
                                                <?php
                                                if (count($arr_tbdg) > 0) {
                                                    $k = 1;
                                    ...
                                    <div class="row toggle-money">
                                        ...
                                        <div class="col-xs-12 col-sm-8 col-md-10">
                                            <input <?php echo $disables_txt; ?> type="text" id="ORG_NAME" name="ORG_NAME" class="form-control" placeholder="หน่วยงานร่วมดำเนินงาน" value="<?php echo text($rec["ORG_NAME"]); ?>">
                                        </div>
                                    </div>
                                    <div class="row">
                            ...
                            <div class="panel panel-default">
                                ...
                                <div class="panel-body epm-gradient">
                                    ...
                                    <div class="row toggle-money">
                                        ...
                                        <div class="col-xs-12 col-sm-8 col-md-4">
                                            <label><input <?php echo $disables_txt; ?> name="COOR_CHK_EMAIL2" id="COOR_CHK_EMAIL2" value="1" type="checkbox" <?php if ($rec["COOR_CHK_EMAIL2"] == 1) {
                                                                                                                                                                    echo "checked";
                                    ...
                                    <div class="row toggle-money">
                                        <div class="col-xs-12 col-sm-4 col-md-2" style="white-space:nowrap;"> </div>
                                        <div class="col-xs-12 col-sm-8 col-md-4">
                                            <label><input <?php echo $disables_txt; ?> name="COOR_CHK_EMAIL" id="COOR_CHK_EMAIL" value="1" type="checkbox" <?php if ($rec["COOR_CHK_EMAIL"] == 1) {
                                                                                                                                                                echo "checked";
                                                                                                                                                            } ?> /> รับการแจ้งเตือน Email</label>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-xs-12 col-sm-8 col-md-4">
                                            <input <?php echo $disables_txt; ?> type="text" id="USER_ADD_PROJECT" name="USER_ADD_PROJECT" class="form-control" placeholder="ผู้บันทึกข้อมูล" value="<?php echo text($rec["USER_ADD_PROJECT"]); ?>">
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-xs-12 col-sm-4 col-md-2" style="white-space:nowrap;">เบอร์โทรศัพท์ :</div>
                                        <div class="col-xs-12 col-sm-8 col-md-4">
                                            <input <?php echo $disables_txt; ?> type="text" id="USER_ADD_PROJECT_TEL" name="USER_ADD_PROJECT_TEL" class="form-control" placeholder="เบอร์โทรศัพท์" value="<?php echo text($rec["USER_ADD_PROJECT_TEL"]); ?>">
                                        </div>
                                    </div>
                                    <div class="row">
                                        ...
                                        <div class="col-xs-12 col-sm-8 col-md-4">
                                            <input <?php echo $disables_txt; ?> type="text" id="USER_ADD_PROJECT_EMAIL" name="USER_ADD_PROJECT_EMAIL" class="form-control" placeholder="อีเมล์" value="<?php echo text($rec["USER_ADD_PROJECT_EMAIL"]); ?>" onBlur="check_email(this)">
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-xs-12 col-sm-4 col-md-2" style="white-space:nowrap;"> </div>
                                        <div class="col-xs-12 col-sm-8 col-md-4">
                                            <label><input <?php echo $disables_txt; ?> name="RESP_CHK_EMAIL" id="RESP_CHK_EMAIL" value="1" type="checkbox" <?php if ($rec["RESP_CHK_EMAIL"] == 1) {
                                                                                                                                                                echo "checked";
                                                                                                                                                            } ?> /> รับการแจ้งเตือน Email</label>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                                                ...
                                                                <td>
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-xs-12 col-sm-2" style="white-space:nowrap">
                                                                            <select <?php echo $disables_txt; ?> width="100%" id="SUP_NAME_<?php echo $id_tbr ?>" name="SUP_NAME[]" class="selectbox form-control <?php echo $_SESSION['sys_program_administrator'] == 1 ? '' : ''; ?>" placeholder="ผู้บังคับบัญชา" onChange="get_sup_pos(this, <?php echo $id_tbr ?>); get_sup_low(this, <?php echo $id_tbr ?>)">
                                                                                <option value="" selected></option>
                                                                                <?php
                                        ...
                                        <div class="row toggle-money">
                                            ...
                                            <div class="col-xs-12 col-sm-8 col-md-4">
                                                <select <?php echo $disables_txt; ?> width="100%" id="APPROVE_USER_ID" name="APPROVE_USER_ID" class="form-control selectbox <?php echo $_SESSION['sys_program_administrator'] == 1 ? '' : ''; ?>" placeholder="ผู้อนุมัติโครงการ" onChange="get_user_low(); get_user_pos(); get_user_code();">
                            ...
                            <div class="panel panel-default">
                                ...
                                <div class="panel-body epm-gradient">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-xs-12 col-sm-8 col-md-10">
                                            <select <?php echo $disables_txt; ?> width="100%" id="STRGIC_LVL1_ID" name="STRGIC_LVL1_ID" class="selectbox form-control" onChange="get_lvl1_indicat(this.value);" placeholder="แผน">
                                                <option value="" selected></option>
                                                <?php
                                                if (count($arr_lvl1) > 0) {
                                                    $k = 1;
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-xs-12 col-sm-8 col-md-10">
                                            <select <?php echo $disables_txt; ?> width="100%" id="STRGIC_LVL1_INDICATE_ID" name="STRGIC_LVL1_INDICATE_ID" class="selectbox form-control" placeholder="แผนย่อย">
                                                <option value="" selected></option>
                                                <?php
                                    ...
                                    while ($res_obj_na = $db->db_fetch_array($sql_obj_na)) { ?>
                                        <div class="row">
                                            ...
                                            <div class="col-xs-12 col-sm-8 col-md-8">
                                                <select <?php echo $disables_txt; ?> width="100%" id="OBJECT_STRCIG_ID_<?php echo $res_obj_na['object_id']; ?>" name="OBJECT_STRCIG_ID[<?php echo $res_obj_na['object_id']; ?>]" class="selectbox form-control" placeholder="<?php echo text($res_obj_na['object_name']); ?>" onChange="">
                                                    <option value="" selected></option>
                                                    <?php
                            ...
                            <div class="panel panel-default">
                                ...
                                <div class="panel-body epm-gradient">
                                    ...
                                    <div class="row">
                                        <?php if ($_SESSION["sys_group_id"] == '5' || $_SESSION['sys_program_administrator'] == 1) { ?>
                                            ...
                                            <div class="col-xs-12 col-sm-8 col-md-10">
                                                ...
                                                <select <?php echo $disables_txt; ?> width="100%" id="STRGIC_ID" name="STRGIC_ID" class="selectbox form-control <?php echo $_SESSION['sys_program_administrator'] == 1 ? '' : ''; ?>" placeholder="ยุทธศาสตร์" onChange="get_strgy(this);get_st_goal(this);get_task_job('', '');get_strgy_indicate(this);">
                                                    <option value="" selected></option>
                                                    <?php
                                    ...
                                    <div class="row">
                                        <?php if ($_SESSION["sys_group_id"] == '5' || $_SESSION['sys_program_administrator'] == 1) { ?>
                                            ...
                                            <div class="col-xs-12 col-sm-8 col-md-10">
                                                ...
                                                <select <?php echo $disables_txt; ?> width="100%" id="STRGIC_GOAL_ID" name="STRGIC_GOAL_ID" class="selectbox form-control <?php echo $_SESSION['sys_program_administrator'] == 1 ? '' : ''; ?>" placeholder="เป้าหมายยุทธ์ศาสตร์">
                                                    <option value="" selected></option>
                                                    <?php
                                    ...
                                    <div class="row">
                                        <?php if ($_SESSION["sys_group_id"] == '5' || $_SESSION['sys_program_administrator'] == 1) { ?>
                                            ...
                                            <div class="col-xs-12 col-sm-8 col-md-10">
                                                ...
                                                <select <?php echo $disables_txt; ?> width="100%" id="STRGY_ID" name="STRGY_ID" class="selectbox form-control <?php echo $_SESSION['sys_program_administrator'] == 1 ? '' : ''; ?>" placeholder="กลยุทธ์" onChange="get_task_job(this.value, '');get_strgy_indicate(this);">
                                                    <option value="" selected></option>
                                                    <?php
                                    ...
                                    <div class="row">
                                        <?php if ($_SESSION["sys_group_id"] == '5' || $_SESSION['sys_program_administrator'] == 1) { ?>
                                            ...
                                            <div class="col-xs-12 col-sm-8 col-md-10">
                                                ...
                                                <select <?php echo $disables_txt; ?> width="100%" id="STRGIC_INDICATE_ID" name="STRGIC_INDICATE_ID" class="selectbox form-control <?php echo $_SESSION['sys_program_administrator'] == 1 ? '' : ''; ?>" placeholder="ตัวชี้วัดกลยุทธ์" onChange="get_task_job($('#STRGY_ID').val(), this.value);">
                                                    <option value="" selected></option>
                                                    <?php
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-xs-12 col-sm-8 col-md-10">
                                            <?php if ($_SESSION["sys_group_id"] == '5' || $_SESSION['sys_program_administrator'] == 1) { ?>
                                                <select <?php echo $disables_txt; ?> width="100%" id="TASK_JOB_ID" name="TASK_JOB_ID" class="selectbox form-control <?php echo $_SESSION['sys_program_administrator'] == 1 ? '' : ''; ?>" placeholder="แผนงาน">
                                                    <option value="" selected></option>
                                                    <?php
                                                    if (count($arr_task) > 0) {
                                                        $k = 1;
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-xs-12 col-sm-8 col-md-10">
                                            <table width="98%" class="table table-bordered table-striped table-hover table-condensed">
                                                ...
                                                ?>
                                                        <tr>
                                                            <td align="center"><input <?php echo $disables_txt; ?> name="MAIN_GOAL_ID[]" id="MAIN_GOAL_ID_<?php echo $key; ?>" value="<?php echo $key; ?>" type="checkbox" <?php echo $arr_chk_main_goal[$key]; ?>></td>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-xs-12 col-sm-8 col-md-10">
                                            <?php if ($_SESSION["sys_group_id"] == '5' || $_SESSION['sys_program_administrator'] == 1) { ?>
                                                <select <?php echo $disables_txt; ?> width="100%" id="STRGIC_ID2" name="STRGIC_ID2" class="selectbox form-control <?php echo $_SESSION['sys_program_administrator'] == 1 ? '' : ''; ?>" placeholder="แนวทางการดำเนินงาน" onChange="get_strgy2(this);">
                                                    <option value="" selected></option>
                                                    <?php
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-xs-12 col-sm-8 col-md-10">
                                            <?php if ($_SESSION["sys_group_id"] == '5' || $_SESSION['sys_program_administrator'] == 1) { ?>
                                                <select <?php echo $disables_txt; ?> width="100%" id="STRGY_ID2" name="STRGY_ID2" class="selectbox form-control <?php echo $_SESSION['sys_program_administrator'] == 1 ? '' : ''; ?>" placeholder="กลยุทธ์">
                                                    <option value="" selected></option>
                                                    <?php
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-xs-12 col-sm-8 col-md-10">
                                            <?php if ($_SESSION["sys_group_id"] == '5' || $_SESSION['sys_program_administrator'] == 1) { ?>
                                                <select <?php echo $disables_txt; ?> width="100%" id="STRGIC_ID3" name="STRGIC_ID3" class="form-control <?php echo $_SESSION['sys_program_administrator'] == 1 ? '' : ''; ?>" placeholder="ยุทธศาสตร์ของ สสว." onChange="get_strgy3(this);get_st_goal3(this);get_strgy_indicate3(this);">
                                                    <option value="" selected></option>
                                                    <?php
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-xs-12 col-sm-8 col-md-10">
                                            <?php if ($_SESSION["sys_group_id"] == '5' || $_SESSION['sys_program_administrator'] == 1) { ?>
                                                <select <?php echo $disables_txt; ?> width="100%" id="STRGIC_GOAL_ID3" name="STRGIC_GOAL_ID3" class="selectbox form-control <?php echo $_SESSION['sys_program_administrator'] == 1 ? '' : ''; ?>" placeholder="เป้าหมายยุทธ์ศาสตร์">
                                                    <option value="" selected></option>
                                                    <?php
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-xs-12 col-sm-8 col-md-10">
                                            <?php if ($_SESSION["sys_group_id"] == '5' || $_SESSION['sys_program_administrator'] == 1) { ?>
                                                <select <?php echo $disables_txt; ?> width="100%" id="STRGY_ID3" name="STRGY_ID3" class="form-control <?php echo $_SESSION['sys_program_administrator'] == 1 ? '' : ''; ?>" placeholder="กลยุทธ์" onChange="get_strgy_indicate3(this);">
                                                    <option value="" selected></option>
                                                    <?php
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-xs-12 col-sm-8 col-md-10">
                                            <?php if ($_SESSION["sys_group_id"] == '5' || $_SESSION['sys_program_administrator'] == 1) { ?>
                                                <select <?php echo $disables_txt; ?> width="100%" id="STRGIC_INDICATE_ID3" name="STRGIC_INDICATE_ID3" class="selectbox form-control <?php echo $_SESSION['sys_program_administrator'] == 1 ? '' : ''; ?>" placeholder="ตัวชี้วัดกลยุทธ์">
                                                    <option value="" selected></option>
                                                    <?php
                            ...
                            <div class="panel panel-default">
                                ...
                                <div class="panel-body epm-gradient">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-xs-12 col-sm-8 col-md-10">
                                            <select <?php echo $disables_txt; ?> width="100%" id="PRO_DESC" name="PRO_DESC" class="selectbox form-control" placeholder="ลักษณะโครงการ">
                                                <option value="" selected></option>
                            ...
                            <div class="panel panel-default">
                                ...
                                <div class="panel-body epm-gradient">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-xs-12 col-sm-8 col-md-10">
                                            <select <?php echo $disables_txt; ?> width="100%" id="BUS_SIZE" name="BUS_SIZE" class="selectbox form-control" placeholder="ขนาดธุรกิจ">
                                                <option value="" selected></option>
                            ...
                            <div class="panel panel-default">
                                ...
                                <div class="panel-body epm-gradient">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-xs-12 col-sm-8 col-md-10">
                                            <select <?php echo $disables_txt; ?> width="100%" id="LIFE_CYCLE" name="LIFE_CYCLE" class="selectbox form-control" placeholder="Life Cycle">
                                                <option value="" selected></option>
                            ...
                            <div class="panel panel-default">
                                ...
                                <div class="panel-body epm-gradient">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-xs-12 col-sm-8 col-md-10">
                                            <select <?php echo $disables_txt; ?> width="100%" id="MSME_GROUP" name="MSME_GROUP" class="selectbox form-control" placeholder="กลุ่มการส่งเสริม MSME">
                                                <option value="" selected></option>
                            ...
                            <div class="panel panel-default">
                                ...
                                <div class="panel-body epm-gradient">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-xs-12 col-sm-8 col-md-10">
                                            <select <?php echo $disables_txt; ?> width="100%" id="VALUE_CHAIN" name="VALUE_CHAIN" class="selectbox form-control" placeholder="Value chain">
                                                <option value="" selected></option>
                            ...
                            <div class="panel panel-default">
                                ...
                                <div class="panel-body epm-gradient">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-xs-12 col-sm-8 col-md-10">
                                            <select <?php echo $disables_txt; ?> width="100%" id="GOVE_POLICY" name="GOVE_POLICY" class="selectbox form-control" placeholder="มตินโยบายรัฐ">
                                                <option value="" selected></option>
                            ...
                            <div class="panel panel-default">
                                ...
                                <div class="panel-body epm-gradient">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-xs-12 col-sm-8 col-md-10">
                                            <select <?php echo $disables_txt; ?> width="100%" id="HIGH_IMPACT" name="HIGH_IMPACT" class="selectbox form-control" placeholder="High Impact">
                                                <option value="" selected></option>
                                                ...
                                                <div class="col-xs-12 col-sm-12 col-md-12">
                                                    <table width="98%" class="table table-bordered table-striped table-hover table-condensed">
                                                        <tr>
                                                            ...
                                                            ?>
                                                                    <td width="15%">
                                                                        <input <?php echo $disables_txt; ?> name="GOAL_TYPE_ID[]" id="GOAL_TYPE_ID_<?php echo $key; ?>" value="<?php echo $key; ?>" type="checkbox" <?php echo $arr_prjp_major_m[$key] ?> onClick="CheckAll_MA(<?php echo $key; ?>);" class="css_data_main_m_<?php echo $key; ?> class_zone11">&nbsp;&nbsp;<?php echo text($val) . "<br>"; ?>
                                                                        <?php
                                                                        if (count($arr_goal_major[$key]) > 0) {
                                                                            foreach ($arr_goal_major[$key] as $key1 => $val1) {
                                                                        ?>
                                                                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input <?php echo $disables_txt; ?> name="GOAL_MAJOR_ID[<?php echo $key; ?>][<?php echo $key1 ?>]" id="GOAL_MAJOR_ID_<?php echo $key . "_" . $key1; ?>" class="css_data_item_m_<?php echo $key; ?>" type="checkbox" onClick="Checkmain_MA(<?php echo $key; ?>,<?php echo $key1; ?>);" value="<?php echo $key1; ?>" <?php echo $arr_prjp_major_ms[$key][$key1]; ?>>&nbsp;&nbsp;<?php echo text($val1) . "<br>"; ?>
                                                                        <?php
                                                                            }
                                                                        } ?>
                                                                    </td>
                                    ...
                                    <div class="panel panel-default">
                                        ...
                                        <div class="panel-body epm-gradient">
                                            ...
                                            <table width="70%" class="table table-bordered table-striped table-hover table-condensed" id="tb_area_in">
                                                <tr class="bgHead">
                                                    <td align="left"> <input <?php echo $disables_txt; ?> name="CHECK_ALL" id="CHECK_ALL" value="1" type="checkbox" onClick="CheckAll();" <?php if (count($arr_chk_all) == 77) {
                                                                                                                                                                    echo "checked";
                                                                                                                                                                } ?>>&nbsp;&nbsp;ทั่วประเทศ</td>
                                                ...
                                                <tr valign="top">
                                                    ...
                                                    foreach ($arr_m1 as $key => $val) { ?>
                                                        <td>
                                                            <input <?php echo $disables_txt; ?> name="CHECK_ALL_IN[]" id="CHECK_ALL_IN_<?php echo $key; ?>" value="<?php echo $key; ?>" type="checkbox" <?php echo $arr_chk_zone[$key] ?> onClick="CheckAll_IN(<?php echo $key; ?>);" class="css_data_main_<?php echo $key; ?> class_zone">&nbsp;&nbsp;<?php echo $val . "<br>"; ?>

                                                            <?php
                                                            foreach ($arr_m2[$key] as $key1 => $val1) {
                                                            ?>
                                                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input <?php echo $disables_txt; ?> name="PROVINCE_CODE[<?php echo $key; ?>][<?php echo $key1 ?>]" id="PROVINCE_CODE_<?php echo $key . "_" . $key1; ?>" class="css_data_item_<?php echo $key; ?> class_province" type="checkbox" onClick="Checkmain(<?php echo $key; ?>,<?php echo $key1; ?>);" value="<?php echo $key1; ?>" <?php echo $arr_chk_in[$key][$key1]; ?>>&nbsp;&nbsp;<?php echo $val1 . "<br>"; ?>
                                                            <?php
                                                            } ?>
                                                        </td>
                                                    <?php
                                            ...
                                            <table width="70%" class="table table-bordered table-striped table-hover table-condensed" id="tb_area_out">
                                                ...
                                                <tr valign="top">
                                                    ...
                                                    foreach ($arr_m3 as $key => $val) { ?>
                                                        <td>
                                                            <input <?php echo $disables_txt; ?> name="CHECK_ALL_OUT[]" id="CHECK_ALL_OUT_<?php echo $key; ?>" value="<?php echo $key; ?>" type="checkbox" <?php echo $arr_chk_area[$key] ?> onClick="CheckAll_OUT(<?php echo $key; ?>);" class="css_data_main_out_<?php echo $key; ?> class_area">&nbsp;&nbsp;<?php echo $val . "<br>"; ?>
                                                            <?php
                                                            foreach ($arr_m4[$key] as $key1 => $val1) {
                                                            ?>
                                                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input <?php echo $disables_txt; ?> name="COUNTRY_ID[<?php echo $key; ?>][<?php echo $key1 ?>]" id="COUNTRY_ID_<?php echo $key . "_" . $key1; ?>" class="css_data_item1_<?php echo $key; ?> class_country" type="checkbox" onClick="Checkmain_out(<?php echo $key; ?>,<?php echo $key1; ?>);" value="<?php echo $key1; ?>" <?php echo $arr_chk_out[$key][$key1]; ?>>&nbsp;&nbsp;<?php echo $val1 . "<br>"; ?>
                                                            <?php
                                                            } ?>
                                                        </td>
                                                    <?php
