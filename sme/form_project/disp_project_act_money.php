...
$sql_head="SELECT PRJP_CODE,PRJP_NAME,EDATE_PRJP,SDATE_PRJP,PROLONG_STATUS,MONEY_BDG,PRJP_CON_ID, PRJP_STATUS, ISNULL(SERVICE_PROJECT_ID, 0) as SERVICE_PROJECT_ID FROM prjp_project WHERE PRJP_ID = '".$PRJP_ID."' order by ORDER_ROW_1,ORDER_ROW_2,ORDER_ROW_3,ORDER_NO ";
...
$sql = "SELECT 	a.PRJP_ID,a.PRJP_CODE,a.PRJP_NAME,a.SDATE_PRJP,a.EDATE_PRJP,a.MONEY_BDG,a.ORDER_NO, a.COST_TYPE,
	...
	<div class="col-xs-12 col-sm-12">
		<div class="groupdata" >
			<form id="frm-search" method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>">
                ...
                <div class="row"><div class="col-xs-12 col-sm-12"><?php include("tab_menu.php");?></div></div>
								...
								<a href="javascript:void(0)" onClick="chk_old(hide_old.value);"><?php echo $img_save;?> แผนการใช้จ่ายเงินเก่า</a>
									...
									<div class="row" id="tab_old" style="display:none;"> 
										<table boder='1' align='left'>
											<tr>
												<td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
												<====
									<?php for($row_tbo=1;$row_tbo<=$row_who;$row_tbo++){ ?>
									...
									<table width="22%" class="table table-bordered table-striped table-hover table-condensed">
										...
										<tr class="bgHead table-head-money">
																<th width="40px" rowspan="2"><div align="center"><strong>ลำดับ</strong></div></th>
																<th width="230px" rowspan="2"><div align="center"><strong>ชื่อกิจกรรม</strong></div></th>
																<th width="100px" rowspan="2"><div align="center"><strong>เงินที่วางแผน</strong></div></th>
																<?php /*?><th width="95px" rowspan="2"><div align="center"><strong>ยอดสะสม</strong></div></th><?php */?>
																<th rowspan="2"><div align="center"><strong></strong></div></th>
																<th colspan="12"><div align="center"><strong>แผนการใช้จ่ายงบประมาณประจำปี <?php echo $_SESSION['year_round']; ?></strong> (บาท)</div></th>
										</tr>
										<tr class="bgHead ">
										<?php 
										foreach($rro as $key => $val){ 
											...
											$syho = substr($val,2,2);
										?>
										 <th width="110px"><div align="center"><strong><?php echo $month[$smho*1].$syho; ?></strong></div></th>
										<?php }} ?>
										</tr>
										</thead>
										<tbody>
										...
										<tr bgcolor="#FFFFFF" class="table-body-money">
																...
																<td align="left" rowspan="2" width="222px">
																	<textarea rows="3"  class="prjp-name-show" disabled=""><?php echo text($reco['PRJP_NAME']);?></textarea>
																</td>
										...
										<td align="center" style="background:#afeeee">แผน</td>
										 <?php 
											...
											if($totalChild > 0){
												...
												$readonly = ($rec_head['PRJP_STATUS']=='2' || $rec_head['PRJP_STATUS']=='3' || $rec_head['SERVICE_PROJECT_ID']=='0') ? "" : "readonly";
											}
											?>
											<input <?php echo $readonly; ?> prjp-parent-id="<?php echo $reco["PRJP_PARENT_ID"]; ?>"  
											month="<?php echo $m_do; ?>" year="<?php echo $y_do; ?>" prjp-id="<?php echo $reco['PRJP_ID']; ?>" 
											name="BDG_VALUE[<?php echo $reco['PRJP_ID']; ?>][<?php echo $y_do;?>][<?php echo $m_do; ?>]" 
											id="BDG_VALUE_<?php echo $reco['PRJP_ID']; ?>_<?php echo $k; ?>" type="hidden" size="5" 
											class="form-control number_format chk_v_<?php echo $reco['PRJP_ID']; ?>_<?php echo $y_do;?>_<?php echo $m_do;?> 
											sum_vt_<?php echo $reco['PRJP_ID']; ?> prec_<?php echo $y_do;?>_<?php echo $m_do; ?>" 
											value="<?php echo number_format($arr_pro[$reco['PRJP_ID']][$y_do][$m_do],2); ?>" 
											onBlur="Chk_val(this.value,'<?php echo $reco['MONEY_BDG']; ?>',<?php echo $reco['PRJP_ID']; ?>,'<?php echo $y_do; ?>','<?php echo $m_do; ?>');
											...
											<?php } ?></td>
											 <?php }//if
																 $k++;}//foreach ?>
										</tr><script>Chk_sval('<?php echo $c_arro; ?>',<?php echo $reco['PRJP_ID']; ?>);</script>
										<?php 
												...
												while($recChild = $db->db_fetch_array($queryChild)){
													?>
														...
														<td align="left" rowspan="2" width="210px">
															<textarea rows="3"  class="prjp-name-show" disabled=""><?php echo text($recChild['PRJP_NAME']);?></textarea>
														</td>
										...
										<td align="center" style="background:#afeeee" >
											<?php if($mo[$key]==''){
												echo "-";}else{
											?>
											<input name="VAL_PER[<?php echo $recChild['PRJP_ID']; ?>][<?php echo $y_do;?>][<?php echo $m_do; ?>]" 
											id="VAL_PER_<?php echo $recChild['PRJP_ID']; ?>_<?php echo $y_d; ?>_<?php echo $m_d; ?>" 
											type="hidden" size="5" class="form-control number_format sper_<?php echo $y_do; ?>_<?php echo $m_do; ?>_<?php echo $l; ?>" 
											value="<?php echo number_format(($arr_po[$recChild['PRJP_ID']][$y_do][$m_do]/$recChild['MONEY_BDG'])*$recChild['WEIGHT'],2);?>">
											...
											$readonly = ($rec_head['PRJP_STATUS']=='2' || $rec_head['PRJP_STATUS']=='3' || $rec_head['SERVICE_PROJECT_ID']=='0') ? "" : "readonly";
											?>
																 <input <?php echo $readonly; ?> prjp-parent-id="<?php echo $recChild["PRJP_PARENT_ID"]; ?>"  
																 month="<?php echo $m_do; ?>" year="<?php echo $y_do; ?>"  prjp-id="<?php echo $recChild['PRJP_ID']; ?>" 
																 onBlur="Chk_val(this.value,'<?php echo $recChild['MONEY_BDG']; ?>',<?php echo $recChild['PRJP_ID']; ?>,'<?php echo $y_do; ?>','<?php echo $m_do; ?>');
																 ...
																 cal_child(this);  
																 NumberFormat(this,2);" 
																 name="BDG_VALUE[<?php echo $recChild['PRJP_ID']; ?>][<?php echo $y_do;?>][<?php echo $m_do; ?>]" 
																 id="BDG_VALUE_<?php echo $recChild['PRJP_ID']; ?>_<?php echo $k; ?>" 
																 type="hidden" size="5" class="form-control number_format sum_vt_<?php echo $recChild['PRJP_ID']; ?> 
																 chk_v_<?php echo $recChild['PRJP_ID']; ?>_<?php echo $y_do;?>_<?php echo $m_do;?>" 
																 value="<?php echo number_format($arr_pr[$recChild['PRJP_ID']][$y_do][$m_do],2); ?>"   
									...
									<div id="tb_<?php echo $row; ?>" class=" col-xs-12 col-sm-12 htb" style="">
										<table width="22%" class="table table-bordered table-striped table-hover table-condensed">
											...
											<tr class="bgHead table-head-money">
																	<th width="40px" rowspan="2"><div align="center"><strong>ลำดับ</strong></div></th>
																	<th width="230px" rowspan="2"><div align="center"><strong>ชื่อกิจกรรม</strong></div></th>
																	<th rowspan="2"><div align="center"><strong>ประเภทค่าใช้จ่าย</strong></div></th>
																	<th width="100px" rowspan="2"><div align="center"><strong>เงินที่วางแผน</strong></div></th>
																	<?php /*?><th width="95px" rowspan="2"><div align="center"><strong>ยอดสะสม</strong></div></th><?php */?>
																	<th rowspan="2"><div align="center"><strong></strong></div></th>
																	<th colspan="12"><div align="center"><strong>แผนการใช้จ่ายงบประมาณประจำปี <?php echo $_SESSION['year_round']; ?></strong> (บาท)</div></th>
											...
											<tr bgcolor="#FFFFFF" class="table-body-money">
																	...
																	<td align="left" rowspan="2" width="222px">
																		<textarea rows="3"  class="prjp-name-show" disabled=""><?php echo text($rec['PRJP_NAME']);?></textarea>
																	</td>
																	<td align="right" rowspan="2" width="105px"><?php echo $arr_bdg_cost[$rec['COST_TYPE']]; ?></td>
											...
											<td align="center" style="background:#afeeee">แผน</td>
											 <?php 
												...
												month="<?php echo $m_d; ?>" year="<?php echo $y_d; ?>" prjp-id="<?php echo $rec['PRJP_ID']; ?>" 
												name="BDG_VALUE[<?php echo $rec['PRJP_ID']; ?>][<?php echo $y_d;?>][<?php echo $m_d; ?>]" 
												id="BDG_VALUE_<?php echo $rec['PRJP_ID']; ?>_<?php echo $k; ?>" type="text" size="5" 
												class="form-control chk_v_<?php echo $rec['PRJP_ID']; ?>_<?php echo $y_d;?>_<?php echo $m_d;?> 
												sum_vt_<?php echo $rec['PRJP_ID']; ?> prec_<?php echo $y_d;?>_<?php echo $m_d; ?>" 
												value="<?php echo number_format($arr_pr[$rec['PRJP_ID']][$y_d][$m_d],2); ?>" 
												onBlur="Chk_val(this.value,'<?php echo $rec['MONEY_BDG']; ?>',<?php echo $rec['PRJP_ID']; ?>,'<?php echo $y_d; ?>','<?php echo $m_d; ?>');
												Chk_sval('<?php echo $c_arr; ?>',<?php echo $rec['PRJP_ID']; ?>);
												pre_val('<?php echo $y_d; ?>','<?php echo $m_d ?>','<?php echo $rec_head['MONEY_BDG']; ?>');
												NumberFormat(this,2);" style="text-align:right"><?php } ?></td>
												 <?php }//if
																	 $k++;}//foreach ?>
											</tr><script>Chk_sval('<?php echo $c_arr; ?>',<?php echo $rec['PRJP_ID']; ?>);</script>
											<?php 
											...
											<td align="center" style="background:#afeeee" >
												<?php if($m[$key]==''){
													echo "";}else{
												?>
												<input name="VAL_PER[<?php echo $recChild['PRJP_ID']; ?>][<?php echo $y_d;?>][<?php echo $m_d; ?>]" 
												id="VAL_PER_<?php echo $recChild['PRJP_ID']; ?>_<?php echo $y_d; ?>_<?php echo $m_d; ?>" 
												type="hidden" size="5" class="form-control number_format sper_<?php echo $y_d; ?>_<?php echo $m_d; ?>_<?php echo $l; ?>" 
												value="<?php echo number_format(($arr_p[$recChild['PRJP_ID']][$y_d][$m_d]/$recChild['MONEY_BDG'])*$recChild['WEIGHT'],2);?>">
												...
												?>
																	 <input <?php echo $readonly; ?> prjp-parent-id="<?php echo $recChild["PRJP_PARENT_ID"]; ?>"  
																	 month="<?php echo $m_d; ?>" year="<?php echo $y_d; ?>"  prjp-id="<?php echo $recChild['PRJP_ID']; ?>" 
																	 onBlur="Chk_val(this.value,'<?php echo $recChild['MONEY_BDG']; ?>',<?php echo $recChild['PRJP_ID']; ?>,'<?php echo $y_d; ?>','<?php echo $m_d; ?>');
																	 ...
																	 cal_child(this);  
																	 NumberFormat(this,2);" 
																	 name="BDG_VALUE[<?php echo $recChild['PRJP_ID']; ?>][<?php echo $y_d;?>][<?php echo $m_d; ?>]" 
																	 id="BDG_VALUE_<?php echo $recChild['PRJP_ID']; ?>_<?php echo $k; ?>" 
																	 type="text" size="5" class="form-control sum_vt_<?php echo $recChild['PRJP_ID']; ?> 
																	 chk_v_<?php echo $recChild['PRJP_ID']; ?>_<?php echo $y_d;?>_<?php echo $m_d;?>" 
																	 value="<?php echo number_format($arr_pr[$recChild['PRJP_ID']][$y_d][$m_d],2); ?>"   
																	 style="text-align:right"><?php } ?></td>
																	 <?php }//if
				...
				<div class="clearfix" align="center">
					<?php if($_SESSION['sys_status_edit']=='1' && ($rec_head['PRJP_STATUS']=='2' || $rec_head['PRJP_STATUS']=='3' || $rec_head['SERVICE_PROJECT_ID']=='0')){ ?>	
