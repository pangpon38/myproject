...
$sql = "SELECT 	a.PRJP_PARENT_ID,a.PRJP_ID,a.PRJP_CODE,a.PRJP_NAME,a.UNIT_ID,a.WEIGHT,a.TRAGET_VALUE,a.UNIT_NAME,a.ORDER_NO,
				...
				(select sum(BDG_VALUE) from prjp_report_task_temp where prjp_report_task_temp.PRJP_ID = a.PRJP_ID)as s_val
		  		FROM prjp_project a 
			...
			<div class="panel-body epm-gradient">
				...
				FROM prjp_project a WHERE PRJP_ID = '" . $rec_head['PRJP_CON_ID'] . "'
					";
									...
									$sum_po = array();
									$sum_ro = array();
									$sql_value_pto = "select prjp_plan_task_temp.MONTH,prjp_plan_task_temp.YEAR,prjp_plan_task_temp.BDG_VALUE ,prjp_project.PRJP_ID,((((prjp_plan_task_temp.BDG_VALUE/prjp_project.TRAGET_VALUE)*100)*prjp_project.WEIGHT)/100)as per_val
					FROM prjp_plan_task_temp 
					JOIN prjp_project ON prjp_project.PRJP_ID = prjp_plan_task_temp.PRJP_ID
					...
					";
									...
									while ($rec_value_pto = $db->db_fetch_array($query_value_pto)) {
										...
										$sql_value_pt_childo = "select prjp_plan_task_temp.MONTH,prjp_plan_task_temp.YEAR,prjp_plan_task_temp.BDG_VALUE ,prjp_project.PRJP_ID,((((prjp_plan_task_temp.BDG_VALUE/prjp_project.TRAGET_VALUE)*100)*prjp_project.WEIGHT)/100)as per_val
										FROM prjp_plan_task_temp 
										JOIN prjp_project ON prjp_project.PRJP_ID = prjp_plan_task_temp.PRJP_ID
					...
					";
									...
									while ($rec_sum_po = $db->db_fetch_array($query_value_pto)) {
										$sql_sum_p_childo = "select prjp_plan_task_temp.MONTH,prjp_plan_task_temp.YEAR,prjp_plan_task_temp.BDG_VALUE ,prjp_project.PRJP_ID,
										((prjp_plan_task_temp.BDG_VALUE/prjp_project.TRAGET_VALUE)*prjp_project.WEIGHT)as pper
										FROM prjp_plan_task_temp 
										JOIN prjp_project ON prjp_project.PRJP_ID = prjp_plan_task_temp.PRJP_ID
									...
									$sql_value_pro = "select prjp_report_task_temp.MONTH,prjp_report_task_temp.YEAR,prjp_report_task_temp.BDG_VALUE ,prjp_project.PRJP_ID
					FROM prjp_report_task_temp 
					JOIN prjp_project ON prjp_project.PRJP_ID = prjp_report_task_temp.PRJP_ID
					WHERE prjp_project.PRJP_PARENT_ID = '" . $rec_head['PRJP_CON_ID'] . "'
					";
									...
									while ($rec_value_pro = $db->db_fetch_array($query_value_pro)) {
										...
										$sql_value_pr_childo = "select prjp_report_task_temp.MONTH,prjp_report_task_temp.YEAR,prjp_report_task_temp.BDG_VALUE ,prjp_project.PRJP_ID
									FROM prjp_report_task_temp 
									JOIN prjp_project ON prjp_project.PRJP_ID = prjp_report_task_temp.PRJP_ID
					...
					<div id="tb_<?php echo $row; ?>" class=" col-xs-12 col-sm-12 ">
						<table class="table table-bordered table-striped table-hover table-condensed" id="TestTable">
							...
							<tbody>
								...
								//แผน
								$sum_p = array();
								$sql_value_pt = "select prjp_plan_task_temp.MONTH,
											prjp_plan_task_temp.YEAR,
											prjp_plan_task_temp.BDG_VALUE,
											prjp_project.PRJP_ID,
											((((prjp_plan_task_temp.BDG_VALUE/prjp_project.TRAGET_VALUE)*100)*prjp_project.WEIGHT)/100) as per_val
									FROM    prjp_plan_task_temp 
									JOIN    prjp_project ON prjp_project.PRJP_ID = prjp_plan_task_temp.PRJP_ID
						...
						while($r_fix = $db->db_fetch_array($fixed_qry)){
							...
							foreach($fix_data as $rec_fix){
								...
								$db->db_insert("prjp_plan_task_temp",$add_fix);
							}
						}
						...
						$query_value_pt = $db->query($sql_value_pt);
								...
								while ($rec_value_pt = $db->db_fetch_array($query_value_pt)) {
									...
									$sql_value_pt_child = "select   prjp_plan_task_temp.MONTH,
														prjp_plan_task_temp.YEAR,
														prjp_plan_task_temp.BDG_VALUE,
														prjp_project.PRJP_ID,
														((((prjp_plan_task_temp.BDG_VALUE/prjp_project.TRAGET_VALUE)*100)*prjp_project.WEIGHT)/100) as per_val
								...
								while ($rec_sum_p = $db->db_fetch_array($query_value_pt)) {
									$sql_sum_p_child = "select  prjp_plan_task_temp.MONTH,
													prjp_plan_task_temp.YEAR,
													prjp_plan_task_temp.BDG_VALUE,
													prjp_project.PRJP_ID,
													((prjp_plan_task_temp.BDG_VALUE/prjp_project.TRAGET_VALUE)*prjp_project.WEIGHT)as pper
								...
								//ผล
								$sql_value_pr = "select prjp_report_task_temp.MONTH,prjp_report_task_temp.YEAR,prjp_report_task_temp.BDG_VALUE ,prjp_project.PRJP_ID
						FROM prjp_report_task_temp 
						JOIN prjp_project ON prjp_project.PRJP_ID = prjp_report_task_temp.PRJP_ID
						WHERE prjp_project.PRJP_PARENT_ID = '" . $PRJP_ID . "'
						";
								...
								while ($rec_value_pr = $db->db_fetch_array($query_value_pr)) {
									...
									$sql_value_pr_child = "select prjp_report_task_temp.MONTH,prjp_report_task_temp.YEAR,prjp_report_task_temp.BDG_VALUE ,prjp_project.PRJP_ID
										FROM prjp_report_task_temp 
										JOIN prjp_project ON prjp_project.PRJP_ID = prjp_report_task_temp.PRJP_ID
