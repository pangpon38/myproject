...
$sql = "SELECT 	a.PRJP_PARENT_ID,a.PRJP_ID,a.PRJP_CODE,a.PRJP_NAME,a.UNIT_ID,a.WEIGHT,a.TRAGET_VALUE,a.UNIT_NAME,a.ORDER_NO,
				...
				(select sum(BDG_VALUE) from prjp_report_task_temp as prjp_report_task  where prjp_report_task.PRJP_ID = a.PRJP_ID)as s_val
		  		FROM prjp_project a 
...
?>
		...
		<div id="tbo_<?php echo $rowo; ?>" class=" col-xs-12 col-sm-12 htbo data_old" style="display:none;" >
			<table  class="table table-bordered table-striped table-hover table-condensed" >
				<thead>
					<tr class="bgHead">
					  <th  rowspan="2"><div align="center"><strong>ลำดับ</strong></div></th>
					  <th rowspan="2" ><div align="center"><strong>ชื่อกิจกรรม</strong></div></th>
					  <th rowspan="2"  nowrap><div align="center"><strong>% ถ่วง<br />น้ำหนัก</strong></div></th>
					  <th rowspan="2" ><div align="center"><strong>เป้าหมาย</strong></div></th>
					  <th rowspan="2" ><div align="center"><strong>ยอดสะสม</strong></div></th>
					  <th rowspan="2" ><div align="center"><strong>หน่วยนับ</strong></div></th>
					  <th rowspan="2" ><div align="center"><strong></strong></div></th>
					  <th colspan="12"><div align="center"><strong>ระยะเวลาการดำเนินงาน-โครงการ/กิจกรรม ปี <?php echo $_SESSION['year_round']; ?></strong></div></th>
					</tr>
					<tr class="bgHead">
					<?php 
					foreach($rro as $key => $val){ 
						...
						$syho = substr($val,2,2);
					?>
					 <th ><div align="center"><strong><?php echo $month[$smho*1].$syho; ?></strong></div></th>
					<?php }} ?>
					</tr>
				</thead>
				<tbody>
	...
	<?php                 
					...
					<tr bgcolor="#FFFFFF">
					 ...
					 <?php 
						...
						<?php if($mo[$key]==''){
							echo "-";}else{
						?>
						<?php echo @number_format($arr_po[$reco_task['PRJP_ID']][$y_do][$m_do],2); }?></td>
						<?php
								}//if 
							}//foreach
						?>
			...
			<input   <?php echo $readonly; ?>  prjp-parent-id="<?php echo $reco_task["PRJP_PARENT_ID"]; ?>"  
			prjp-act-id="<?php echo $reco_task['PRJP_ID']; ?>"  month="<?php echo $m_do; ?>"  
			name="BDG_VALUE[<?php echo $reco_task['PRJP_ID']; ?>][<?php echo $y_do;?>][<?php echo $m_do;?>]" 
			id="BDG_VALUE_<?php echo $reco_task['PRJP_ID']; ?>_<?php echo $k; ?>" 
			type="hidden" size="5" class="form-control number_format PVO_<?php echo $ii; ?>_<?php echo $k; ?>" 
			value="<?php echo number_format($arr_ro[$reco_task['PRJP_ID']][$y_do][$m_do],2); ?>" 
			onBlur="Chk_sval('<?php echo $c_arro; ?>','<?php echo $reco_task['PRJP_ID']; ?>','<?php echo $rec_head['SW']; ?>','<?php echo $rec_head['ST']; ?>','<?php echo $y_do; ?>','<?php echo $m_do; ?>');
			Sum_result_old('<?php echo $c_arro; ?>','<?php echo $num_rowso; ?>','<?php echo $ymchk_js; ?>');NumberFormat(this,2);" 
			style="text-align:right;<?php echo $bgdis; ?>" <?php echo $distxt; ?>>
			...
			<?php } ?></td>    
					...
					<tr bgcolor="#FFFFFF">
					 ...
					 <?php 
						...
						?>
						<?php echo @number_format($arr_po[$recChild['PRJP_ID']][$y_do][$m_do],2); }?></td>
						<?php
								}//if 
							}//foreach
						?>
					...
					<tr bgcolor="#FFFFFF">
					  <td align="center" style="background:#afeeee">ผล</td>
					   <?php 
						...
						<input prjp-parent-id="<?php echo $recChild["PRJP_PARENT_ID"]; ?>"  
						prjp-act-id="<?php echo $recChild['PRJP_ID']; ?>" month="<?php echo $m_do; ?>" 
						name="BDG_VALUE[<?php echo $recChild['PRJP_ID']; ?>][<?php echo $y_do;?>][<?php echo $m_do;?>]" 
						id="BDG_VALUE_<?php echo $recChild['PRJP_ID']; ?>_<?php echo $k; ?>" type="hidden" size="5" 
						class="form-control number_format PVO_<?php echo $ii; ?>_<?php echo $k; ?>" 
						value="<?php echo number_format($arr_ro[$recChild['PRJP_ID']][$y_do][$m_do],2); ?>" 
						onBlur="Chk_sval('<?php echo $c_arro; ?>','<?php echo $recChild['PRJP_ID']; ?>','<?php echo $rec_head['SW']; ?>','<?php echo $rec_head['ST']; ?>','<?php echo $y_do; ?>','<?php echo $m_do; ?>');
						Sum_result_old('<?php echo $c_arro; ?>','<?php echo $num_rowso; ?>','<?php echo $ymchk_js; ?>');
				...
				<table  class="table table-bordered table-striped table-hover table-condensed" >
					<thead>
						...
						foreach($rr as $key => $val){ 
							...
							$syh = substr($val,2,2);
						?>
						 <th ><div align="center"><strong><?php echo $month[$smh*1].$syh; ?></strong></div></th>
						<?php }} ?>
						</tr>
					</thead>
					<tbody>
					...
					$sql_value_pr = "select prjp_report_task.MONTH,prjp_report_task.YEAR,prjp_report_task.BDG_VALUE ,prjp_project.PRJP_ID
						FROM prjp_report_task_temp as  prjp_report_task
						JOIN prjp_project ON prjp_project.PRJP_ID = prjp_report_task.PRJP_ID
						WHERE prjp_project.PRJP_PARENT_ID = '".$PRJP_ID."'
						";
                ...
                <tr class="tr-body-rtask" bgcolor="#FFFFFF">
                 ...
                 <?php 
                    ...
                    <?php if($m[$key]==''){
						echo "";}else{
                    ?>
                    <?php echo @number_format($arr_p[$rec['PRJP_ID']][$y_d][$m_d],2); }?></td>
                    <?php
							}//if 
						}//foreach
					?>
		...
		<input <?php echo $arr_readonly[$rec['PRJP_ID']]; ?>  <?php echo $readonly; ?>  prjp-parent-id="<?php echo $rec["PRJP_PARENT_ID"]; ?>"
		prjp-act-id="<?php echo $rec['PRJP_ID']; ?>"  month="<?php echo $m_d; ?>"  
		name="BDG_VALUE[<?php echo $rec['PRJP_ID']; ?>][<?php echo $y_d;?>][<?php echo $m_d;?>]" id="BDG_VALUE_<?php echo $rec['PRJP_ID']; ?>_<?php echo $k; ?>" 
		type="text" size="5" class="form-control PV_ACT_<?php echo $ii; ?>_<?php echo $k; ?>" value="<?php echo number_format($arr_r[$rec['PRJP_ID']][$y_d][$m_d],2); ?>" 
		onBlur="Chk_sval('<?php echo $c_arr; ?>','<?php echo $rec['PRJP_ID']; ?>','<?php echo $rec_head['SW']; ?>','<?php echo $rec_head['ST']; ?>','<?php echo $y_d; ?>','<?php echo $m_d; ?>');
		Sum_result_act('<?php echo $c_arr; ?>','<?php echo $num_rows; ?>','<?php echo $ymchk_js; ?>');NumberFormat(this,2);" 
		style="text-align:right;<?php echo $bgdis; ?>" <?php echo $distxt; ?>><?php } ?></td>    
				 <?php }//if
				   $k++;}//foreach ?>
                </tr>
				<script>
                ...
                <tr bgcolor="#FFFFFF" class="tr-body-rtask">
                 ...
                 <?php 
                    ...
                    ?>
                    <?php echo @number_format($arr_p[$recChild['PRJP_ID']][$y_d][$m_d],2); }?></td>
                    <?php
							}//if 
						}//foreach
					?>
                ...
                <tr bgcolor="#FFFFFF" class="tr-body4-rtask">
                  <td align="center" style="background:#afeeee">ผล</td>
                   <?php 
                    ...
                    <input <?php echo $arr_readonly[$recChild['PRJP_ID']]; ?> prjp-parent-id="<?php echo $recChild["PRJP_PARENT_ID"]; ?>"
					prjp-act-id="<?php echo $recChild['PRJP_ID']; ?>" 
					month="<?php echo $m_d; ?>" name="BDG_VALUE[<?php echo $recChild['PRJP_ID']; ?>][<?php echo $y_d;?>][<?php echo $m_d;?>]" 
					id="BDG_VALUE_<?php echo $recChild['PRJP_ID']; ?>_<?php echo $k; ?>" type="text" size="5" 
					class="form-control PV_ACT_<?php echo $ii; ?>_<?php echo $k; ?>" 
					value="<?php echo number_format($arr_r[$recChild['PRJP_ID']][$y_d][$m_d],2); ?>" 
					onBlur="Chk_sval('<?php echo $c_arr; ?>','<?php echo $recChild['PRJP_ID']; ?>','<?php echo $rec_head['SW']; ?>','<?php echo $rec_head['ST']; ?>','<?php echo $y_d; ?>','<?php echo $m_d; ?>');NumberFormat(this,2); cal_child(this);" 
					style="text-align:right;<?php echo $bgdis; ?>" <?php echo $distxt; ?> ><?php } ?></td>
				 <?php }//if
				   $k++;}//foreach ?>
                </tr>
