...
$sql_head = "SELECT PRJP_CODE,PRJP_NAME,EDATE_PRJP,SDATE_PRJP,PROLONG_STATUS,MONEY_BDG,PRJP_CON_ID,BDG_TYPE_ID, PRJP_STATUS, ISNULL(SERVICE_PROJECT_ID, 0) as SERVICE_PROJECT_ID FROM prjp_project WHERE PRJP_ID = '" . $PRJP_ID . "'";
	...
	<div class="container-full ">
		...
		<div class="col-xs-12 col-sm-12">
			<ol class="breadcrumb">
				...
				<li class="active">รายละเอียดผลผลิต</li>
			</ol>
		</div>
			...
			<div class="groupdata">
				<form id="frm-search" method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>">
					...
					<div class="row div1-fix-width">
						<div class="col-xs-12 col-sm-12 text-center"><strong class="font-blue"><?php echo $rec_head['PRJP_CODE'] . " " . text($rec_head['PRJP_NAME']) ?></strong></div>
					</div>
					<div class="row div1-fix-width">
												...
												<table width="22%" class="table table-bordered table-striped table-hover table-condensed">
													<thead>
														<tr class="bgHead">
															...
															<th width="15%">
																<div align="center"><strong>ชื่อ/รายละเอียดผลผลิต</strong></div>
															</th>
															...
															<th width="10%">
																<div align="center"><strong>ประเภทหน่วยนับ</strong></div>
															</th>
														</tr>
													</thead>
													<tbody>
														...
														?>
																<tr bgcolor="#FFFFFF">
																	...
																	<td align="center"><?php if ($rec_prjold['TYPE_PRO_ID'] != '9999') {
																							echo text($rec_prjold['TYPE_PRO_NAME']);
																						} else {
																							echo  "อื่น ๆ";
																						} ?></td>
																	...
																	<td align="center"><?php
																						if ($rec_prjold['TYPE_PRO_ID'] != '9999') {
																							...
																							echo  text($rec_prjold['UNIT_PRO_NAME']);
																						} ?></td>
																</tr>
														<?php
																$i++;
												...
												<tbody>
													...
													?>
															<tr bgcolor="#FFFFFF">
																...
																<?php /*?><td align="left"><?php echo text($rec['PRJP_PRODUCT_DESC']);?></td><?php */ ?>
																<td align="center"><?php if ($rec['TYPE_PRO_ID'] != '9999') {
																						echo text($rec['TYPE_PRO_NAME']);
																					} else {
																						echo  "อื่น ๆ";
																					} ?></td>
																<td align="right"><?php echo number_format($rec['GOAL_VALUE'], 2); ?></td>
																<td align="center"><?php if ($rec['UNIT_ID'] != '') {
					...
					<?php include("disp_project_act_task_copy.php"); ?>
