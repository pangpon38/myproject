...
from '+@DBNAME+'.dbo.V_ACC_TRANSEC_DETAIL a where acc_gl_id = ''52'' and a.acc_close = ''0'' 
'+@condition+''
...
SET @ParameterDef='@dr_sum_1 FLOAT OUTPUT'
SET @SQLString = 'select @dr_sum_1=ISNULL(sum(debit_value),0)
from '+@DBNAME+'.dbo.V_ACC_TRANSEC_DETAIL a where acc_gl_id = ''53'' and a.acc_close = ''0'' 
'+@condition+''
EXEC sp_Executesql @SQLString,@ParameterDef,@dr_sum_1 OUTPUT
...
SET @ParameterDef='@dr_sum_1 FLOAT OUTPUT'
SET @SQLString = 'select @dr_sum_1=ISNULL(sum(debit_value),0)
from '+@DBNAME+'.dbo.V_ACC_TRANSEC_DETAIL a where acc_gl_id = ''54'' and a.acc_close = ''0'' 
'+@condition+''
EXEC sp_Executesql @SQLString,@ParameterDef,@dr_sum_1 OUTPUT
...
SET @ParameterDef='@dr_sum_1 FLOAT OUTPUT'
SET @SQLString = 'select @dr_sum_1=ISNULL(sum(debit_value),0)
from '+@DBNAME+'.dbo.V_ACC_TRANSEC_DETAIL a where acc_gl_id = ''55'' and a.acc_close = ''0'' 
'+@condition+''
EXEC sp_Executesql @SQLString,@ParameterDef,@dr_sum_1 OUTPUT
...
SET @ParameterDef='@dr_sum_1 FLOAT OUTPUT'
SET @SQLString = 'select @dr_sum_1=ISNULL(sum(debit_value),0)
from '+@DBNAME+'.dbo.V_ACC_TRANSEC_DETAIL a where acc_gl_id = ''56'' and a.acc_close = ''0'' 
'+@condition+''
EXEC sp_Executesql @SQLString,@ParameterDef,@dr_sum_1 OUTPUT
...
SET @ParameterDef='@dr_sum_1 FLOAT OUTPUT'
SET @SQLString = 'select @dr_sum_1=ISNULL(sum(debit_value),0)
from '+@DBNAME+'.dbo.V_ACC_TRANSEC_DETAIL a where acc_gl_id = ''20'' and a.acc_close = ''0'' 
'+@condition+''
EXEC sp_Executesql @SQLString,@ParameterDef,@dr_sum_1 OUTPUT
...
SET @ParameterDef='@dr_sum_1 FLOAT OUTPUT'
SET @SQLString = 'select @dr_sum_1=ISNULL(sum(debit_value),0)
from '+@DBNAME+'.dbo.V_ACC_TRANSEC_DETAIL a where acc_gl_id = ''58'' and a.acc_close = ''0'' 
'+@condition+''
EXEC sp_Executesql @SQLString,@ParameterDef,@dr_sum_1 OUTPUT
...
SET @ParameterDef='@dr_sum_1 FLOAT OUTPUT'
SET @SQLString = 'select @dr_sum_1=ISNULL(sum(debit_value),0)
from '+@DBNAME+'.dbo.V_ACC_TRANSEC_DETAIL a where acc_gl_id = ''71'' and a.acc_close = ''0'' 
'+@condition+''
EXEC sp_Executesql @SQLString,@ParameterDef,@dr_sum_1 OUTPUT
...
SET @ParameterDef='@dr_sum_1 FLOAT OUTPUT'
SET @SQLString = 'select @dr_sum_1=ISNULL(sum(debit_value),0)
from '+@DBNAME+'.dbo.V_ACC_TRANSEC_DETAIL a where acc_gl_id = ''68'' and a.acc_close = ''0'' 
'+@condition+''
EXEC sp_Executesql @SQLString,@ParameterDef,@dr_sum_1 OUTPUT
...
SET @ParameterDef='@dr_sum_1 FLOAT OUTPUT'
SET @SQLString = 'select @dr_sum_1=ISNULL(sum(debit_value),0)
from '+@DBNAME+'.dbo.V_ACC_TRANSEC_DETAIL a where acc_gl_id = ''67'' and a.acc_close = ''0'' 
'+@condition+''
EXEC sp_Executesql @SQLString,@ParameterDef,@dr_sum_1 OUTPUT
...
SET @ParameterDef='@dr_sum_1 FLOAT OUTPUT'
SET @SQLString = 'select @dr_sum_1=ISNULL(sum(debit_value),0)
from '+@DBNAME+'.dbo.V_ACC_TRANSEC_DETAIL a where acc_gl_id = ''90'' and a.acc_close = ''0'' 
'+@condition+''
EXEC sp_Executesql @SQLString,@ParameterDef,@dr_sum_1 OUTPUT
...
SET @ParameterDef='@dr_sum_1 FLOAT OUTPUT'
SET @SQLString = 'select @dr_sum_1=ISNULL(sum(debit_value),0)
from '+@DBNAME+'.dbo.V_ACC_TRANSEC_DETAIL a where acc_gl_id = ''72'' and a.acc_close = ''0'' 
'+@condition+''
EXEC sp_Executesql @SQLString,@ParameterDef,@dr_sum_1 OUTPUT
...
SET @ParameterDef='@dr_sum_1 FLOAT OUTPUT'
SET @SQLString = 'select @dr_sum_1=ISNULL(sum(debit_value),0)
from '+@DBNAME+'.dbo.V_ACC_TRANSEC_DETAIL a where acc_gl_id = ''80'' and a.acc_close = ''0'' 
'+@condition+''
EXEC sp_Executesql @SQLString,@ParameterDef,@dr_sum_1 OUTPUT
...
SET @ParameterDef='@dr_sum_1 FLOAT OUTPUT'
SET @SQLString = 'select @dr_sum_1=ISNULL(sum(debit_value),0)
from '+@DBNAME+'.dbo.V_ACC_TRANSEC_DETAIL a where acc_gl_id = ''85'' and a.acc_close = ''0'' 
'+@condition+''
EXEC sp_Executesql @SQLString,@ParameterDef,@dr_sum_1 OUTPUT
...
SET @ParameterDef='@dr_sum_1 FLOAT OUTPUT'
SET @SQLString = 'select @dr_sum_1=ISNULL(sum(debit_value),0)
from '+@DBNAME+'.dbo.V_ACC_TRANSEC_DETAIL a where acc_gl_id = ''93'' and a.acc_close = ''0'' 
'+@condition+''
EXEC sp_Executesql @SQLString,@ParameterDef,@dr_sum_1 OUTPUT
...
SET @ParameterDef='@dr_sum_1 FLOAT OUTPUT'
SET @SQLString = 'select @dr_sum_1=ISNULL(sum(debit_value),0)
from '+@DBNAME+'.dbo.V_ACC_TRANSEC_DETAIL a where acc_gl_id = ''73'' and a.acc_close = ''0'' 
'+@condition+''
EXEC sp_Executesql @SQLString,@ParameterDef,@dr_sum_1 OUTPUT
...
SET @ParameterDef='@dr_sum_1 FLOAT OUTPUT'
SET @SQLString = 'select @dr_sum_1=ISNULL(sum(debit_value),0)
from '+@DBNAME+'.dbo.V_ACC_TRANSEC_DETAIL a where acc_gl_id = ''95'' and a.acc_close = ''0'' 
'+@condition+''
EXEC sp_Executesql @SQLString,@ParameterDef,@dr_sum_1 OUTPUT
...
SET @ParameterDef='@dr_sum_1 FLOAT OUTPUT'
SET @SQLString = 'select @dr_sum_1=ISNULL(sum(debit_value),0)
from '+@DBNAME+'.dbo.V_ACC_TRANSEC_DETAIL a where acc_gl_id = ''25'' and a.acc_close = ''0'' 
'+@condition+''
EXEC sp_Executesql @SQLString,@ParameterDef,@dr_sum_1 OUTPUT
...
SET @ParameterDef='@dr_sum_1 FLOAT OUTPUT'
SET @SQLString = 'select @dr_sum_1=ISNULL(sum(debit_value),0)
from '+@DBNAME+'.dbo.V_ACC_TRANSEC_DETAIL a where acc_gl_id = ''120'' and a.acc_close = ''0'' 
'+@condition+''
EXEC sp_Executesql @SQLString,@ParameterDef,@dr_sum_1 OUTPUT
...
SET @ParameterDef='@dr_sum_1 FLOAT OUTPUT'
SET @SQLString = 'select @dr_sum_1=ISNULL(sum(debit_value),0)
from '+@DBNAME+'.dbo.V_ACC_TRANSEC_DETAIL a where acc_gl_id = ''61'' and a.acc_close = ''0'' 
'+@condition+''
EXEC sp_Executesql @SQLString,@ParameterDef,@dr_sum_1 OUTPUT
...
SET @ParameterDef='@dr_sum_1 FLOAT OUTPUT'
SET @SQLString = 'select @dr_sum_1=ISNULL(sum(debit_value),0)
from '+@DBNAME+'.dbo.V_ACC_TRANSEC_DETAIL a where acc_gl_id = ''63'' and a.acc_close = ''0'' 
'+@condition+''
EXEC sp_Executesql @SQLString,@ParameterDef,@dr_sum_1 OUTPUT
...
SET @ParameterDef='@dr_sum_1 FLOAT OUTPUT'
SET @SQLString = 'select @dr_sum_1=ISNULL(sum(debit_value),0)
from '+@DBNAME+'.dbo.V_ACC_TRANSEC_DETAIL a where acc_gl_id = ''84'' and a.acc_close = ''0'' 
'+@condition+''
EXEC sp_Executesql @SQLString,@ParameterDef,@dr_sum_1 OUTPUT
...
SET @ParameterDef='@dr_sum_1 FLOAT OUTPUT'
SET @SQLString = 'select @dr_sum_1=ISNULL(sum(debit_value),0)
from '+@DBNAME+'.dbo.V_ACC_TRANSEC_DETAIL a where acc_gl_id = ''66'' and a.acc_close = ''0'' 
'+@condition+''
EXEC sp_Executesql @SQLString,@ParameterDef,@dr_sum_1 OUTPUT
