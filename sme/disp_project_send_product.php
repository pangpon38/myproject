                            ...
                            <div class="panel panel-default">
                                ...
                                <div class="panel-body epm-gradient">
                                                        ...
                                                        ?>
                                                                <tr bgcolor="#FFFFFF">
                                                                    ...
                                                                    <td align="center">
                                                                        ...
                                                                        <input name="PLAN_VALUE[<?php echo $val; ?>][<?php echo $rec['PRJP_PRODUCT_ID']; ?>]" id="PLAN_VALUE_<?php echo $val; ?>" type="text" size="5" class="form-control number_format" value="<?php echo number_format($arr_pval[$rec['PRJP_PRODUCT_ID']][$val], 2); ?>" onBlur="NumberFormat(this, 2);" style="text-align:right" <?php echo $distxt; ?>>
                                                                    </td>
                                                                    <td align="left">
                                                                        รายละเอียดการดำเนินงาน :
                                                                        <br />
                                                                        <textarea name="DESC_NAME[<?php echo $val; ?>][<?php echo $rec['PRJP_PRODUCT_ID']; ?>]" <?php echo $distxt; ?> id="DESC_NAME_<?php echo $val; ?>" rows="3"><?php echo text($arr_desc[$rec['PRJP_PRODUCT_ID']][$val]); ?></textarea>
                                                                        <br />
                                                                        ปัญหาและอุปสรรค :
                                                                        <br />
                                    ...
                                    <div class="col-xs-12 col-sm-12 tb_v" id="show_rb_99999">
                                        <div class="">
                                            <div style="margin-bottom:10px;"><a data-toggle="modal" class="btn btn-default" data-backdrop="static" href="javascript:void(0);" onClick="addrow_file();"><?php echo $img_save; ?> เพิ่มเอกสาร</a>
                                                <font color="red"> * กรุณาแนบไฟล์เอกสาร รายละเอียดที่เกี่ยวกับโครงการ สกุลไฟล์ .gif,jpg,Ms.Word,Ms.excel,PDF เป็นต้น ขนาดไฟล์ต่อ 1 ไฟล์ ห้ามเกิน 10MB</font>
                                            </div>
