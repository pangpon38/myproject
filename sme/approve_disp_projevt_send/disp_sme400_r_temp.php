													...
													<thead>
														<tr class="bgHead">
															...
															<th width="20%" rowspan="2">
																<div align="center"><strong>กิจกรรม / ผลผลิต </strong></div>
															</th>
															<th width="20%" rowspan="2">
																<div align="center"><strong>กิจกรรม / ผลผลิต (ที่ขอเปลี่ยนแปลง)</strong></div>
															</th>
															<th width="20%" rowspan="2">
																<div align="center"><strong>ระยะเวลาการดำเนินงาน (ที่ขอเปลี่ยนแปลง)</strong></div>
															</th>
															<th width="20%" rowspan="2">
																<div align="center"><strong>คำชี้แจงและเหตุผล</strong></div>
															</th>
															<th width="5%" rowspan="2">
													...
													<tbody>
														...
														?>
															<tr>
																...
																<td>
																	<input <?php echo $disables_txt; ?> type="text" id="PRJP_ACT_<?php echo $i; ?>" name="PRJP_ACT[]" value="<?php echo $rec_file['PRJP_ACT']; ?>">
																</td>
																<td>
																	<input <?php echo $disables_txt; ?> type="text" id="PRJP_ACT_CHANGE_<?php echo $i; ?>" name="PRJP_ACT_CHANGE[]" value="<?php echo $rec_file['PRJP_ACT_CHANGE']; ?>">
																</td>
																<td>
																	<input <?php echo $disables_txt; ?> type="text" id="DESC_CHANGE_<?php echo $i; ?>" name="DESC_CHANGE[]" value="<?php echo $rec_file['DESC_CHANGE']; ?>">
																</td>
																<td>
																	<input <?php echo $disables_txt; ?> type="text" id="COMMENT_<?php echo $i; ?>" name="COMMENT[]" value="<?php echo $rec_file['COMMENT']; ?>">
																</td>
																<td align="center">
